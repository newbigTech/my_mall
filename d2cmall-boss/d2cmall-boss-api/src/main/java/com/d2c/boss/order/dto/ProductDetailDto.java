...
public class ProductDetailDto implements Serializable {
	...
	public ProductDetailDto(String storeSn, String picture, String externalSn, String color, String size, Date billDate,
			Integer quantity, String topCategory, BigDecimal tagPrice) {
