...
public class PaymentController extends BaseController {
	...
	public ResponseResult payment(Model model, @RequestParam(required = true) String orderSn,
		...
		IPaymentInterface order = orderService.doFindByOrderSnAndMemberInfoId(orderSn, memberInfo.getId());
		...
		} else if (OrderTypeEnum.COLLAGE.name().equalsIgnoreCase(orderType)) {
