...
import com.d2c.cms.model.SubModule.ParentEnum;
import com.d2c.cms.query.SectionValueSearcher;
import com.d2c.cms.search.model.SearcherSection;
import com.d2c.cms.search.query.SectionSearchBean;
import com.d2c.cms.search.service.SectionSearcherService;
import com.d2c.cms.service.AdResourceService;
import com.d2c.cms.service.SectionService;
import com.d2c.cms.service.SectionValueService;
import com.d2c.cms.service.SubModuleQueryService;
import com.d2c.cms.service.SubModuleService;
...
public class PageController extends BaseController {
	...
	public ResponseResult brandRecommends(Integer pageSize) {
		...
		Map<Long, List<SearcherProduct>> map = productSearcherQueryService.findNewUpMarketByBrand(10, 6, designerIds);
		JSONArray array = new JSONArray();
	...
	public ResponseResult productRecommends(String subModuleName, PageModel page) {
		...
		PageResult<SearcherProduct> pageRes = productSearcherQueryService.findTopRecom(query, page);
		ResponseResult result = new ResponseResult();
		JSONArray array = new JSONArray();
	...
	public ResponseResult flashPromotion(ProductSearcher searcher) {
		ResponseResult result = new ResponseResult();
		List<FlashPromotion> list = flashPromotionService.findNoEndOrderByScore();
		...
		ProductProSearchQuery searcherBean = searcher.initSearchQuery();
	...
	public ResponseResult newUpInfo() {
		...
		// 上新的一级分类数量
		Map<Long, Long> topCountJson = productSearcherQueryService.findNewUpGoodsCountGroupTopCategory(20, 20);
	...
	public ResponseResult newUpBrand(PageModel page, Long topId) {
		...
		List<Long> designerIds = productSearcherQueryService.findNewUpGoodsGroupByBrand(20, 1000, topIds);
