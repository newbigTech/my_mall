...
public class BaseController extends BaseDeviceController {
	...
	protected void InitBinder(WebDataBinder dataBinder) {
		dataBinder.registerCustomEditor(Integer.class, "refundStatus", new PropertyEditorSupport() {
			@Override
			public void setAsText(String value) {
				if (StringUtils.isNotBlank(value)) {
					setValue(RefundStatus.valueOf(value).getCode());
				}
			}
		...
		dataBinder.registerCustomEditor(Integer.class, "reshipStatus", new PropertyEditorSupport() {
			@Override
			public void setAsText(String value) {
				if (StringUtils.isNotBlank(value)) {
					setValue(ReshipStatus.valueOf(value).getCode());
				}
			}
		...
		dataBinder.registerCustomEditor(Integer.class, "exchangeStatus", new PropertyEditorSupport() {
			@Override
			public void setAsText(String value) {
				if (StringUtils.isNotBlank(value)) {
					setValue(ExchangeStatus.valueOf(value).getCode());
				}
			}
