...
import static com.d2c.flame.enums.ProductCategoryEnum.BAG;
import static com.d2c.flame.enums.ProductCategoryEnum.COSMETIC;
import static com.d2c.flame.enums.ProductCategoryEnum.FEMALE;
import static com.d2c.flame.enums.ProductCategoryEnum.FURNITURE;
import static com.d2c.flame.enums.ProductCategoryEnum.JEWELRY;
import static com.d2c.flame.enums.ProductCategoryEnum.KIDS;
import static com.d2c.flame.enums.ProductCategoryEnum.MALE;
...
import com.d2c.cms.service.ArticleService;
...
public class BrandController extends BaseController {
	...
	private List<String> processBySpecialTag(Long tagId) {
		...
		if (SpecialBrandTagEnum.isBrand4NewProduct(tagId)) {
			...
			List<Long> list = productSearcherQueryService.findNewUpMarketGroupByBrand(7, 10, topIds);
	...
	private void getProductList(JSONArray array, Long brandId, JSONObject obj, BrandSearcher searcher) {
		...
		String[] sortFields = new String[] { "store", "topical", "seriesUpDate", "sales" };
	...
	public ResponseResult promotionInfo(@PathVariable Long brandId) {
		...
		List<CouponDef> list = couponDefQueryService.findAvailableByBrandId(brandId);
