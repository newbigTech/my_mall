...
public class LightAppController extends BaseController {
	...
	public @ResponseBody void light(HttpServletResponse response, String path) {
	...
	public @ResponseBody void lightApp(HttpServletResponse response, @PathVariable String base64) {
		HttpServletRequest request = getRequest();
		String url = request.getRequestURL().toString();
		String urlParam = request.getQueryString();
		if (StringUtils.isNotBlank(urlParam)) {
	...
	public @ResponseBody void light2App(HttpServletResponse response, @PathVariable("base64") String base64,
