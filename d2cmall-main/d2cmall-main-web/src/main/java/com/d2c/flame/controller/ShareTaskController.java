...
import com.d2c.cms.dto.ShareTaskDefDto;
import com.d2c.cms.model.ShareTask;
import com.d2c.cms.model.ShareTaskClick;
import com.d2c.cms.model.ShareTaskDef;
import com.d2c.cms.query.ShareTaskDefSearcher;
import com.d2c.cms.query.ShareTaskSearcher;
import com.d2c.cms.service.ShareTaskClickService;
import com.d2c.cms.service.ShareTaskDefService;
import com.d2c.cms.service.ShareTaskService;
...
public class ShareTaskController extends BaseController {
	...
	public String list(ModelMap model, PageModel page) {
		...
		// 检查会员已经领取过的任务
		for (ShareTaskDef def : pager.getList()) {
