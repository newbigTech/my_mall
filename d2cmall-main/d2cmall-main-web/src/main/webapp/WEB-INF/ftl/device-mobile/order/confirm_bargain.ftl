    ...
    <form id="confirm-form" class="validate-form"    action="/order/create" method="post" call-back="bargainCreateSuccess">
        ...
        <div class="form">
           ...
           <#list orderItems?if_exists as orderItem>
            ...
            <div class="form-item item-card clearfix">
               <input type="hidden" name="skuId" value="${orderItem.productSkuId}" />
                ...
                <p class="property">${orderItem.sp1?eval.name}：${orderItem.sp1?eval.value}&nbsp;&nbsp;&nbsp;${orderItem.sp2?eval.name}：${orderItem.sp2?eval.value}<span>&nbsp;&nbsp;&nbsp;数量：
           ...
           <#assign exceptions=exceptions+1 />
            ...
            <div class="form-item item-card item-excption clearfix">
                ...
                <p class="property">${orderItem.sp1?eval.name}：${orderItem.sp1?eval.value}&nbsp;&nbsp;&nbsp;${orderItem.sp2?eval.name}：${orderItem.sp2?eval.value}</p>
       ...
       <#list orderItems?if_exists as orderItem>
        ...
        <div class="suspend-bar">
            <div class="desc" data-sn="${order.orderSn}" >应付：<span class="price">&yen; <strong id="now-pay-price" class="price" rel="${order.totalAmount+order.shippingRates}">${order.totalAmount+order.shippingRates}</strong> 元</span></div>
            <input type="hidden" name="cod" value="${cod}" />
            <div class="buttons"><button type="submit" id="submit-button" class="button button-red">去付款</button></div>
        </div>
    </form>
</div>
...
<script id="address-select-template" type="text/html">
    <div class="form-item item-address" data-id="{{id}}" style="padding-right:2em;">
        <span class="icon icon-location"></span>
        <p>{{name}} &nbsp;&nbsp;&nbsp; {{mobile}}</p>
        <p>{{province}}{{city}}{{district}}{{street}}</p>
        <span class="icon icon-arrow-right"></span>
