...
<div class="set-box">
	<form action="/partner/update/store" class="validate-form" method="post" redirect-url="/partner/store" success-tip="店铺信息更新成功">
		<div class="set-item flex space-between">
			<div class="item-label">店铺头像</div>
			<div><img src="//static.d2c.cn/img/home/160627/images/headpic.png" style="width:4em;height:4em;border-radius:100%;"><i style="float:right;margin-top:.5em;background-size:50%;opacity:.6;" class="icon icon-arrow-right"></i></div>
		</div>
		<div class="set-item flex space-between">
			<div class="item-label">店铺名称</div>
			<div class="item-alter"><span style="color:#444;">穷人啊啊啊的店铺</span><i style="float:right;margin-top:.5em;background-size:50%;opacity:.6;" class="icon icon-arrow-right"></i></div>
		</div>
		<div class="set-item flex space-between">
			...
			<div class="item-alter">点击修改<i style="float:right;margin-top:.5em;background-size:50%;opacity:.6;" class="icon icon-arrow-right"></i></div>
		</div>
	</form>
</div>
<!--
