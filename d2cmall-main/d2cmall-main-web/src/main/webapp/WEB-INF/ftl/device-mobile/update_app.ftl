...
.update-button{width:6.25rem;height:1.875rem;line-height:1.875rem;text-align:center;margin:2.5rem auto 0;border:1px solid #262626;color:#262626;font-size:12px;cursor:pointer;}
</style>
