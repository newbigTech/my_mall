...
<@m.page_header back="查看物流" title='查看物流' service='false' hastopfix='false'/>
	...
	<div class="logistics_p">	
		<div class="p_img">
			<a href="javascript:;" style="height:4.4rem;overflow:hidden;display:block;"><img src="${picture_base}/${productImg}" style="width:100%"></a>
		</div>
		<div class="p_content">
			<p><span class="grey">物流状态&nbsp;&nbsp;&nbsp;</span>&nbsp;<span style="color:#03A3ED">${logistics.statusName}</span></p>
