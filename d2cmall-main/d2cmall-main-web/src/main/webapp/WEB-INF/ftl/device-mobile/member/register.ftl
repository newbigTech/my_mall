...
<div class="section">
    ...
    <div class="form">
        <form id="register-form" class="validate-form" redirect-url="${path!'/'}" action="/member/register" method="post">
            ...
            <div class="form-item item-flex">
                <label>验证码</label>
                <input type="text" name="code" id="code" value="" class="input validate" title="短信校验码" placeholder="请输入短信校验码" />
                <button type="button" data-source="" data-type="MEMBERMOBILE" data-way="register" class="button button-s button-white validate-send validate-button">获取校验码</button>
            </div>
            <div class="form-item item-flex">
                <label>登录密码</label>
                <input type="password" name="password" id="password" value="" min-length="8" title="字母数字符号组合" class="input validate"  max-length="20"  placeholder="请设置8-20位登录密码" />
            </div>
            <div class="form-item item-flex">
                <label>确认密码</label>
                <input type="password" name="rePassword" id="re-password" value="" min-length="8" max-length="20" title="重新输入登录密码" compare-with="password" class="input validate" placeholder="请确认一次登录密码" />
            </div>
