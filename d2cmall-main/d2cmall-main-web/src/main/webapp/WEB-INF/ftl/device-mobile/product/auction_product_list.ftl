...
<div class="auction-product-list" id="load-more-product">
	<div class="auction-mymargin"><a href="/auction/member/mymargin"><img src="//static.d2c.cn/img/topic/180510/auction/images/button_myauction@3x.png" width="100%" alt="" /></a></div>
	...
	<div class="product-item auction-flex">
		...
		<div class="product-item-cont">
			<a href="/auction/product/${productItem.id}" style="display:block;"> 
				...
				<div class="product-margin">保证金：&yen; ${productItem.margin?string("currency")?substring(1)}</div>
				<div class="product-current"><#if productItem.statusName == '正在拍卖'>当前<#elseif productItem.statusName == '即将拍卖'>起拍<#else>结拍</#if>价：<span style="font-weight:bold;color:#F21A1A;">&yen; <span style="font-size:24px;">${productItem.currentPrice?string("currency")?substring(1)}</span></span></div>
				...
				<div class="product-status">
					...
					<span class="statu-time count-down" data-type="split-time"  data-endtime="${productItem.endDate?string("yyyy/MM/dd HH:mm:ss")}" data-defined="second">
					...
					<span class="statu-time count-down" data-type="split-time"  data-endtime="${productItem.beginDate?string("yyyy/MM/dd HH:mm:ss")}" data-defined="second">
						<span class="day down-time">00</span>天 
						<span class="hour down-time">00</span> : 
						<span class="minute down-time">00</span> : 
						<span class="second down-time" style="color:#F21A1A;">00</span>
...
<share data-title="1元起拍 等你来出价！" data-desc="臻选精品 限量拍卖"  data-pic="//static.d2c.cn/img/home/160627/images/headpic.png"></share>
<div class="load-more scroll-load-more" data-target="load-more-product" template-id="auction-list-template" data-url="/auction/list" data-page="${productList.pageNumber}" data-total="${productList.pageCount}">点击加载更多</div>
<script id="auction-list-template" type="text/html">
	...
	<div class="product-item auction-flex">
		...
		<div class="product-item-cont">
			...
			<div class="product-current">当前价：<span style="font-weight:bold;color:#F21A1A;">&yen; <span style="font-size:24px;">{{toFixed(productItem.currentPrice)}}</span></span></div>
