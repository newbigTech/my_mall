		...
		<div class="order-item wrap-div" style="margin-bottom:0.6em;">
			<div class="item-main clearfix">
				<p class="img-big" style="min-height:10em;">
					<img src="${static_base}/m/img/blank.gif" data-src="${picture_base}${(setting.product.productImageCover)!}!180" alt="${setting.product.name}" />
				</p>
			...
			<#list setting.product.productSKUSet as productSku>
				<ul class="clearfix">
					...
					<li>
						<div class="num-crease-wrap"><span class="icon-minus decrease"></span><input type="text" class="product-count num" name="quantity" readonly size="1" value="0"><span class="icon-plus increase"></span></div>
