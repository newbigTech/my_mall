...
<share data-title="${partnerStore.name}" data-url="${base}/partner/store?parent_id=${partnerStore.partnerId}" data-pic="${partnerStore.pic}"></share>
<header>
	...
	<div class="partner-item">
		<div class="item-container">
			<div class="flex flex-start margin-bottom">
				<div style="width:4.6em;height:4.6em;margin-right:5%;"><img src="//static.d2c.cn/img/nnm/npc/icon_mine_cash@2x.png" width="100%"></div>
			...
			<div style="float:right;margin-top:-6em;"><span style="font-size:.75em;">&yen;&nbsp;</span><strong style="font-size:1.2em;">{{value.applyAmount | formatPrice:'decimal'}}</strong></div>
