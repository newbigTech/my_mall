...
<div class="section">
	...
	<#list designers as designer>
		...
		<a href="/showroom/designer/${designer.id}" class="designer-link">${designer.name}&nbsp;/&nbsp;<span style="color:#999">${designer.designers}</span><#if designer.recommend==1><i>HOT</i></#if></a></li>
	    </#if>
	</#list>
	</div>
	</#list>
