...
<div class="award-tasked">
 ...
 <div class="task-line">
  <p>每天分享抽奖活动页面</p><a href="javascript:;" class="<#if lotterySource&&lotterySource.SHAREACTIVITY==1>com<#else>gocomplete</#if>" data-id="1"></a>
 </div>
 <div class="task-line">
  <p>参与砍价活动</p><a href="javascript:;"  class="<#if lotterySource&&lotterySource.BARGAIN==1>com<#else>gocomplete</#if>" data-id="2"></a>
 </div>
</div>
...
<div class="award-tasked" style="height:207px">
 ...
 <div class="hide-content" style="height:112.5px;">
     <#list myAttends as list>
		 <div class="task-line">
		  <p>您抽中了${list.awardName}</p><#if list.awardLevel!=1 || list.awardLevel!=3 || list.awardLevel!=4> <a href="javascript:;" class="seebtn do-btn <#if !m.FROMAPP><#if  list.awardLevel==5 || list.awardLevel==6 || list.awardLevel==7 || list.awardLevel==8>level2<#elseif list.awardLevel==2>level3</#if></#if>"  <#if list.awardLevel==5 || list.awardLevel==6 || list.awardLevel==7 || list.awardLevel==8>data-url="/check/redPacket"<#elseif list.awardLevel==2>data-url="/coupon/memberCoupon"</#if> ></a></#if>
		 </div>
	</#list>
 </div>
...
<img src="//static.d2c.cn/other/award/icon_aboutus_logo.png" style="position:relative;width:70px;left:50%;top:20px;margin-left:-35px;"/ >
...
<script type="text/javascript">
	...
	$('#play_btn').on(click_type,function(){
		var that=this;
		if(isLoading){ toast({position:'center',type:'error',message:'请不要多次点击哟~'});  return false;}
		  $.getJSON('/member/islogin',function(data){
			if (data.result.login==false){
				userLogin();
			}else if(data.result.datas.isBind==false){
