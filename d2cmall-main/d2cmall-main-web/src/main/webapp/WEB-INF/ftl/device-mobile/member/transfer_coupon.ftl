...
<style>
 ...
 .share-button,.lq-button,.use-button,.diabale-button{
  background:#fd555d;color:#fff;width:70%;border:none;margin:10px auto;
 }
 .slide-imgs {
    width: 90%;
    overflow-y: hidden;
...
<div class="success-tip">
 ...
 <div class="coupon-item" style="margin-bottom:0;border:1px solid #fd555d;">
    ...
    <#if result.datas.from.id == LOGINMEMBER.id>
    	<div style="text-align:center;"><button class="share-button button" onclick=" $('.share-mask').show();">立即分享</button></div>
    <#elseif result.datas.coupon.memberId== result.datas.from.id>	
    	<div style="text-align:center;"><button class="lq-button button">我要领取</button></div>
    	<div style="text-align:center;"><button class="use-button button" style="display:none" onclick="location.href='http://m.d2cmall.com'">去使用</button></div>
    <#else>
   		<div style="text-align:center;"><button class="diabale-button button" style="background-color:#999">优惠券已领完</button></div>
     </#if>
