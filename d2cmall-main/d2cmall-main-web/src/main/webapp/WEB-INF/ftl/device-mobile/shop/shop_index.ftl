...
<div class="section text-center lazyload">
	...
	<a href="/showroom/designer/${designer.id}" class="item item-flex item-gap"><span class="img"><img alt="${designer.name}" src="${static_base}/m/img/blank100x157.png" data-image="${picture_base}${(designer.introPic)!}" /></span></a>
	</#if>
	</#list> 
	</div>
