...
<div class="section" id="set-password">
    ...
    <div class="form">
        <form id="send-form" class="validate-form"<#if !m.FROMAPP> redirect-url="/member/login"<#else> success-tip="密码修改成功！请重新登录！" call-back="showSuccess"</#if> action="/member/resetPassword" method="post">
            ...
            <div class="form-item">
                <input type="password" name="password" id="password" value="" class="input validate" title="新密码" min-length="8" max-length="20" placeholder="输入您的8-20位新密码" />
            </div>
            <div class="form-item">
                <input type="password" name="repassword" id="repassword" value="" class="input validate" title="确认密码" min-length="8" max-length="20" compare-with="password" placeholder="请确认您的新密码" />
            </div>
