...
<#if articleDescription?size gt 0>
	...
	<#if val.type=='product'>
	<div class="article-product" data-id="${val.productId}" style="display:flex;justify-content:space-bewteen;padding:3%;">
		<a href="/product/${val.productId}" style="display:block;width:50%;"><img src="${picture_base}${val.productPic}" width="100%" alt=""></a>
		<div class="product-cont" style="width:100%;margin-left:20px;">
			<div class="product-text">
				...
				<a href="/product/${val.productId}" style="display:block;height:6em;overflow:hidden;font-size:.875em;padding-top:.5em;color:#212121;line-height:1.5;" class="product-name"></a>
			</div>
			<div class="product-price" style="display:flex;justify-content:space-between;line-height:2em;">
				<div>精选价：<strong  class="price-num"></strong></div>
				<div style="width:5em;height:2em;line-height:2em;text-align:center;background:#232427;"><a style="color:#FFF;" href="/product/${val.productId}">去购买</a></div>
			</div>
		</div>
	</div>	
	</#if>
