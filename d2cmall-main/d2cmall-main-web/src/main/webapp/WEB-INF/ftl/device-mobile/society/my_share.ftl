...
<div class="fullscreen">
	<div class="user defaultbg">
		<div class="user-photo">
			<#if member.headPic>
              <img src="<#if member.headPic?index_of('http') lt 0>//img.d2c.cn</#if>${member.headPic}" class="head-pic"></img>
...
<div class="lshow" style="display:none">
</div>	
		...
		<div class="myshow-area">
			...
			<div class="p-handle">
				<div class="praise section2">
				 <a href="javascript:void(0);" data-url="/membershare/like/insert/${minepage.id}"  class="favbutton button-clear button-s like-me">
					<span class="p-praise">
					</span>
					<span class="n-praise">
						${minepage.likes}
