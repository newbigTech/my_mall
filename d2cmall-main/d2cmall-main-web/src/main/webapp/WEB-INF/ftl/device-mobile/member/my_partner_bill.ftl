		...
		<div class="partner-item">
			<div class="item-container">
	            ...
	            <div class="flex space-between item-gap">
	                <div class="item-img"><img src="//img.d2c.cn{{value.productImg}}" width="100%" alt="{{value.productName}}"></div>
	                <div class="item-cont">
	            ...
	            <div class="flex space-between item-other">
	            	...
	            	<span>{{value.deliveryCorpName}}&nbsp;公司自提<i style="float:right;margin-top:.5em;width:1.2em;height:1.2em;" class="icon icon-arrow-right"></i></span>
	            </div>
	            {{/if}}
	            <div class="flex space-between item-other">
