	...
	<div class="partner-item">
		<div class="item-container">
			<div class="flex flex-start">
				...
				<div style="width:4.6em;height:4.6em;"><img src="{{if value.headPic}}{{value.headPic}}{{else}}//static.d2c.cn/img/home/160627/images/headpic.png{{/if}}" style="width:100%;border-radius:50%;"></div>
