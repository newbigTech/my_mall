...
<header>
    <div class="header">
        ...
        <div class="header-title">会员绑定</div>
    </div>
</header>
<div class="login-modal">
   <div class="section">
    ...
    <div class="form">
    <#if !LOGINMEMBER.d2c>
        <form class="validate-form" action="/member/bind"  method="post" call-back="bindSucess">
            ...
            <div class="form-item item-flex" id="choose-country">
                <label>国家和地区</label>
                <span class="note" style="color:#FD555D;max-width:70%;"><em id="country-code">中国大陆</em>(<em class="choose-country-code">+86</em>)</span>
            </div>
            <div class="form-item">
                <input type="text" name="loginCode" id="loginCode" value="" class="input validate validate-account" title="账号" placeholder="请输入你的D2C账号(邮箱或手机)" />
            </div>
            <div class="message" style="background:#FFFFF0;width:100%;box-sizing:border-box;border:1px dotted #FF3300;font-size:0.6em;padding:0.8em;margin-top:0.1em;display:none;z-index:9"> </div>
            ...
            <div class="form-item">
             ...
             <div class="password-item form-item" style="display:none">
                <input type="password" name="password" value="" class="input" id="password" title="密码" placeholder="请输入8-20位字母数字密码" />
            </div>
             <div class="password-item form-item" style="display:none">
                <input type="password" name="rePassword" value="" class="input" id="rePassword" title="确认密码" placeholder="请确认输入的密码" />
            </div>
            <div class="form-button">
                <button type="button" name="sure-button" id="sure-button" class="button button-l button-red">确定</button>
            </div>  
        </form>
    <#else>
...
var bindSucess=function(){
    $.flashTip({position:'top',type:'error',message:'绑定成功'});
