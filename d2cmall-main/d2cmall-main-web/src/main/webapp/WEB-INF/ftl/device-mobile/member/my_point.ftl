...
<div class="wrap-main">
	...
	<div class="user-nav">
		<ul>
			<li>
				<a href="/member/point/exchange"><span class="icon icon-signout"></span> 积分转钱包 <span class="icon icon-angle-right"></span></a>
			</li>
			<li>
				<a href="/member/account/pointItem"><span class="icon icon-sort-by-attributes-alt"></span> 积分明细 <span class="icon icon-angle-right"></span></a>
			</li>
		</ul>
	</div>
</div>
