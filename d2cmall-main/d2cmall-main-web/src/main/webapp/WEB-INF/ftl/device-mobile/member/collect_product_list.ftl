...
<div class="section lazyload" style="margin-top:0.4em;">
    <div class="list clearfix">
        ...
        <div class="item item-flex item-gap" data-id="${memberCollection.productId}" style="padding-bottom:1em;text-align:center">
            <a href="/product/${memberCollection.productId}" style="display:block;padding-bottom:0.6em">
                <span class="img">
                <img src="${static_base}/m/img/blank100x157.png" data-image="${picture_base}${(memberCollection.productPicFirst)!}!280" alt="" /></span>
                <span class="title">${memberCollection.productName}</span>
            </a>
            <button type="button" data-url="/member/interest/collection/delete/${memberCollection.productId}" confirm="确定取消收藏吗？" call-back="removeItem(${memberCollection.productId})" class="button button-white ajax-request" style="width:50%;padding:0">取消收藏</button>
        </div>
        </#list>
        <div class="pages">
