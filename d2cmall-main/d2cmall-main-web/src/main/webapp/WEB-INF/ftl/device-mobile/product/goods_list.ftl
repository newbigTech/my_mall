...
<div class="section lazyload">
	...
	<div class="load-more scroll-load-more" data-url="/goods/pager?${param}" data-target="load-more-product" template-id="list-template" data-page="${pager.pageNumber}" data-total="${pager.pageCount}">点击加载更多</div>  
	</#if>
	<#else>
	<hr />
