...
<div class="lazyload">
	...
	<div class="load-more scroll-load-more" data-url="/promotion/items?${param}" data-target="load-more-item" template-id="list-template" data-page="${pager.pageNumber}" data-total="${pager.pageCount}">点击加载更多</div>  
	</#if>
	<#else>
	<hr />
