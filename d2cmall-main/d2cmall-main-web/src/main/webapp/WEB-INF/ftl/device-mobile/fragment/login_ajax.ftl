...
<div class="login-modal">
    <div class="section" id="login-section">
        ...
        <div class="form">
             <form id="quick-form" class="validate-form" call-back="loginSucess" action="/member/quick/login" method="post" success-tip="登陆成功~">
                <div class="form-item">
               		<input type="hidden" name="nationCode" disabled="disabled" value="86" class="mobile-code" />
                    <input type="text" name="loginCode" value="" class="input validate validate-account" title="账号" placeholder="请输入手机号" />
                </div>
                <div class="form-item">
                    <input type="text" name="code" id="code" value="" class="input validate" title="校验码" placeholder="请输入校验码" />
               		 <button type="button" data-source="" data-type="MEMBERMOBILE" class="button button-white validate-send validate-button">获取校验码</button>
                </div>
...
<script id="random-code-template" type="text/html">
    <div class="form-item">
        <input type="text" name="randomCode" value="" class="input validate" title="验证码" style="width:70%;" placeholder="请输入右图中的验证码" />
