		...
		<div class="item-container">
			<div class="flex flex-start">
				...
				<div class="item-detail">
					<p style="font-size:1.2em;margin-bottom:.6em;"><strong>{{if value.sourceType == 'BILL'}}返利单{{else}}提现申请{{/if}}{{value.statusName}}</strong></p>
			...
			<div style="float:right;margin-top:-4.5em;"><span style="font-size:.75em;">&yen;&nbsp;</span><strong style="font-size:1.2em;">{{value.amount}}</strong></div>
		</div>
	</div>		
	{{/each}}
</script>
