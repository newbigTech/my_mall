...
<style>
@-webkit-keyframes falsh{from {z-index:1;}to {z-index:3;}}
@keyframes falsh{from {z-index:1;}to {z-index:3;}}
.award_banner{
    position:relative;
    overflow:hidden;
     ...
     <div class="award-task">
        <div class="user-task">
            <div class="task-content" style="padding-left:3%;padding-right:3%;">
               ...
               <p>支持活动期间内所有订单返红包，红包按成功交易订单实付金额返，红包、优惠券不计入实付金额，订单退款退货部分金额将不计入成功交易额中。（例：小G在活动期间多个订单实付金额共计10000元，其中退货退款1000元，成功交易金额则为9000元，小G抽奖抽到50%的订单返红包，最后将得到4500元红包）。</p>
...
<a href="/page/shuangdanjianianhua" class="twozero"><img src="//static.d2c.cn/img/promo/1225/twodan.jpg" width="100%" ></a>
