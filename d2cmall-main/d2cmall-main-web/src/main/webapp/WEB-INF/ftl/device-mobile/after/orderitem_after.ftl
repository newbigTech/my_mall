    ...
    <div class="form">
        <div class="form-item item-card item-margin clearfix">
             <a href="/product/${orderItem.productId}" class="clearfix">
                <span class="img"><img src="<#if orderItem.sp1?exists>${picture_base}/${(orderItem.sp1?eval.img)!}!120</#if>" alt="${orderItem.productName}" /></span>
                ...
                <span class="amount"><em class="unit">${orderItem.productPrice}</em></strong> x ${orderItem.productQuantity}&nbsp;&nbsp;金额：<strong class="price">&yen;${(orderItem.actualAmount)!}</strong>
