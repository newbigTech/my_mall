          ...
          <!-- 暂时关闭钱包支付 
           ...
           -->
            <div class="form-button">
                <button type="submit" name="submit-button" id="pay-button" class="button button-l button-red">确定</button>
            </div>
...
<script id="wallet-pay-template" type="text/html">
    <div class="form">
        <form name="" class="validate-form" action="/member/account/password" call-back="checkWalletPassword" method="post">
            <div class="form-item">
                <input type="password" name="" id="modal-password" value="" class="input input-l text-center validate" title="支付密码" placeholder="请输入钱包支付密码" />
