...
<div class="section">
    ...
    <div class="form">
        <form name="ebox-reg-form" id="ebox-reg-form" class="validate-form" call-back="regSuccess" action="/registration/insert" method="post">
            <input type="hidden" name="defId" value="${def.id}" />
            <div class="form-item item-flex">
                <label>手机</label>
                <input type="text" name="mobile" id="mobile" value="" title="手机" class="input validate" data-rule="mobile" placeholder="请输入您手机号" />
            </div>
            <div class="form-item item-flex">
                <label>姓名</label>
                <input type="text" name="name" id="name" value="" title="姓名" class="input validate" placeholder="请输入您的姓名" />
            </div>
            <div class="form-item item-flex">
                <label>参加人数</label>
                <input type="text" name="num" id="num" title="参加人数" value="" class="input validate" placeholder="有几人来参加" />
            </div>
