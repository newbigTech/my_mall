...
<meta name="keywords" content="<#if keywords==''>d2c官网,D2C,D2CMALL,服装设计,服装设计师,时装设计,服装品牌设计,时尚设计,时装设计师<#else>${keywords},全球好设计,设计师品牌,D2C,D2CMALL,潮流风尚,前沿艺术,个性设计,时装设计师平台,国际新锐设计师品牌,买手店,原创设计</#if>" />
<meta name="description" content="<#if description==''>D2C是一家集潮流风尚、个性设计为一体的设计师集成平台，致力于为消费者推荐全球优秀的设计师品牌，除设计师品牌限量销售外，更有私人定制服务，同时在中国各大城市开设实体店。<#else>${description},全球好设计</#if>" />
<meta http-equiv="imagetoolbar" content="no" />
<meta http-equiv="cache-control" content="no-cache" />
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<meta property="data-title" content="<#if keywords==''>d2c官网,D2C,D2CMALL,服装设计,服装设计师,时装设计,服装品牌设计,时尚设计,时装设计师<#else>${keywords},全球好设计,D2C,D2CMALL,潮流风尚,前沿艺术,个性设计,时装设计师平台,国际新锐设计师品牌,原创设计</#if>" />
...
<#if css?length gt 0>
    <#list css?split("|") as s>
<link type="text/css" href="${static_base}/nc/css/${s}.css?t=${refreshTimeStamp}" rel="stylesheet" media="screen" />
    </#list>
</#if>
<!--[if lt IE 9]>
...
<script type="text/javascript" src="${static_base}/nc/js/utils/jquery.fileupload.js?t=${refreshTimeStamp}"></script>
...
<#macro page_user_menu menu_item=''>
    <div class="user-menu">
        ...
        <dl>
            ...
            <dd<#if menu_item=='order'> class="on"</#if>><a href="/member/order">我的订单</a> <i class="fa fa-chevron-right"></i></dd>
            <dd<#if menu_item=='coupon'> class="on"</#if>><a href="/coupon/myCoupon?status=UNCLAIMED&status=CLAIMED">我的优惠券</a> <i class="fa fa-chevron-right"></i></dd>
            <dd id="myComment" <#if menu_item=='comment'>class="on"</#if>><a href="/comment/list?source=ORDERITEM">我的评论</a> <i class="fa fa-chevron-right"></i></dd>
            <#--<dd <#if menu_item=='award'> class="on"</#if>><a href="/award/my/list?status=0">我的抽奖</a> <i class="fa fa-chevron-right"></i></dd>-->
            <dd <#if menu_item=='my_subscribe'> class="on"</#if>><a href="/o2oSubscribe/my/list">我的预约单</a> <i class="fa fa-chevron-right"></i></dd>
            <dd <#if menu_item=='auction'> class="on"</#if>><a href="/auction/member/mymargin">我的拍卖</a> <i class="fa fa-chevron-right"></i></dd>
        </dl>
        <dl>
            <dt><i class="fa fa-life-ring"></i> 售后服务</dt>
            <dd<#if menu_item=='refund'> class="on"</#if>><a href="/member/refund/list">仅退款</a> <i class="fa fa-chevron-right"></i></dd>
            <dd<#if menu_item=='exchange'> class="on"</#if>><a href="/member/exchange/list">仅换货</a> <i class="fa fa-chevron-right"></i></dd>
            <dd<#if menu_item=='reship'> class="on"</#if>><a href="/member/reship/list">退款退货</a> <i class="fa fa-chevron-right"></i></dd>
        </dl>
        <dl>
            ...
            <dd<#if menu_item=='info'> class="on"</#if>><a href="/member/info">个人信息</a> <i class="fa fa-chevron-right"></i></dd>
            <#if LOGINMEMBER.id!=null && !LOGINMEMBER.d2c>
          	  <dd<#if menu_item=='bind'> class="on"</#if>><a href="/member/bind">绑定账号</a> <i class="fa fa-chevron-right"></i></dd>
            </#if>
            <#if LOGINMEMBER.id!=null && LOGINMEMBER.d2c>
            <dd<#if menu_item=='security'> class="on"</#if>><a href="/member/security">修改密码</a> <i class="fa fa-chevron-right"></i></dd>
            </#if>
            <dd<#if menu_item=='address'> class="on"</#if>><a href="/address/list">收货地址</a> <i class="fa fa-chevron-right"></i></dd>
        </dl>
        <dl>
            <dt><i class="fa fa-fire"></i> 我的兴趣</dt>
            <dd<#if menu_item=='interest_collect'> class="on"</#if>><a href="/member/interest/collection/list">收藏的商品</a> <i class="fa fa-chevron-right"></i></dd>
            <dd<#if menu_item=='interest_attention'> class="on"</#if>><a href="/member/interest/attention/list">关注的设计师</a> <i class="fa fa-chevron-right"></i></dd>
        </dl>
    </div>
</#macro>
	...
	<div class="header-user clearfix">
		<ul>
			<li> 
				...
				<#if LOGINMEMBER.nickname><a href="/member/info">${LOGINMEMBER.nickname}</a><#else><a href="/member/info">亲爱的用户</a></#if><i>｜</i>
					 <#if !LOGINMEMBER.d2c>
    ...
    <div class="layout-response clearfix"  style="position:relative;padding-top:20px">
        ...
        <div class="header-search">
            ...
            <form name="" action="/product/list" method="get" target="_blank">
                <input type="text" name="k" id="header-keyword" class="place-holder-keyword" value="<#if RequestParameters?exists>${RequestParameters.k}</#if>" /><button type="submit" id="header-search"><a href="javascript:" class="search-icon"><i class="fa fa-search"></i></a></button>
            ...
            <#if searchHot?exists && searchHot>
	            <#list searchHot as tip>
	                 <a href="javascript:;" data-url="${base}/${(tip.url)!}" data-id="${(tip.id)!}" class="<#if tip.status=1>red </#if>hotsearch" <#if tip_index==0>style="display:none"</#if>>${(tip.keyword)!}</a> <#if tip_index gt 0>&nbsp;&nbsp;&nbsp;&nbsp;</#if>
	            </#list>
              </#if>
            </div>
        </div>
        <div class="header-right">
        	...
        	<div class="appdown" style="margin-left:60px;">
        		...
        		<p style="font-family:'Microsoft YaHei',微软雅黑,'MicrosoftJhengHei'">注册即送<span class="red" style="font-size:15px;font-weight:600">700</span>元优惠券<p/>
        	</div>
        </div>
    ...
    <div class="layout-response">
        <div class="navi-category navi-category-border">
            ...
            <#list navigations as navs>
                <dl class="category">
                    <dt>
                        <strong><a target="_blank" href="<#if navs.url!="">${navs.url}<#else>/c/${navs.code}</#if>">${navs.name}</a></strong>
                        <p><#if navs.navigationItems?exists && navs.navigationItems?size gt 0>
                        	<#list navs.navigationItems as item>
                            <a target="_blank" <#if item.cssStyle?exists && item.cssStyle!=''> style="${item.cssStyle}"</#if> href="${(item.url)!}">${(item.title)!}</a>
                        	</#list>
                        	</#if>
                        </p>
                    </dt>
                        ...
                        <ul>
                            <li>
	                        	...
	                        	<#list child.navigationItems as item>
                                    <a target="_blank" href="${(item.url)!}">${(item.title)!}<em>｜</em></a>
                                </#list>
                        		</#if>
                                </div>
                            </li>
        ...
        <div class="clearfix">
            ...
            <div class="footer-copyright">
            	...
            	<p style="margin-right:75px;text-align:right;">Powered byD2C-Copyright © 2015 D2CMALL.COM - All Rights Reserved.</p>
            	 <p style="text-align:left;">杭州迪尔西时尚科技有限公司 &nbsp;联系电话：<span style="color:red">${servertel}</span></p>
		        ...
		        <p style="text-align:right;"><a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33019902000183" style="display:inline-block;text-decoration:none;padding-left:5px;color:#666;"><img src="//static.d2c.cn/img/home/160627/images/police.png" style="float:left;"/>浙公网安备 33019902000183号</a></p>
            	</div>
            	<a href="https://ss.knet.cn/verifyseal.dll?sn=e17052533010067889nm6y000000&comefrom=trust" style="display:block;background:url(//static.d2c.cn/common/nc/img/trast.jpg) no-repeat;width:140px;height:60px;"></a>
            </div>
        </div>
    </div>
</div>
...
<script id="cart-template" type="text/html">
    ...
    {{each cart.items as value i}}
        <li>
            ...
            <div class="img"> <a href="/product/{{value.productId}}" target="_blank"><img src="${picture_base}{{value.sp1Img}}!180" width="40"/></a></div>
            <div class="price"><strong>&yen;{{value.price}}<span class="grey" style="padding-left:3px;">X{{value.quantity}}</span></strong></div>
            <div class="title-div"><a href="/product/{{value.productId}}" target="_blank" class="title">{{value.productName}}<a></div>
            <div style="float:right;margin-top:5px;" class="cancel"><a href="javascript:;">删除</a></div>
            <div class="float-left" style="margin-top:5px;"><a href="/product/{{value.productId}}" target="_blank" ><span class="color">颜色：{{value.colorValue}}</span>&nbsp;&nbsp;<span class="color">尺码：{{value.sizeValue}}</span></a></div>
        </li>
    {{/each}}
    </ul>
...
<#macro navigation path='' id=''>
        ...
        <#if navs.path?index_of(path)!=-1><#assign style='show'><#else><#assign style=''></#if>
            <dd class="first"><a href="<#if navs.URL!="">${navs.URL}<#else>/c/${navs.code}</#if>">${navs.name} <span>${navs.code}</span></a>
            <#if id==navs.id><em></em></#if>
            </dd>
            <#list navs.children as child>
            <dd class="second${style}"><a href="<#if child.URL!="">${child.URL}<#else>/c/${child.code}</#if>">${child.name} <span>${child.code}</span></a>
...
<#macro p page totalpage num=''>
    ...
    <#if currentPage lte totalpage - 5 && totalpage gt 10><span>...</span> <a href="?p=${totalpage}&${requestParams}">${totalpage}</a>
    </#if>
