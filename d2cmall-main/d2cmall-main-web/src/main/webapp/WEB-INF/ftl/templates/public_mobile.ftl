...
<meta name="keywords" content="<#if keywords==''>D2C,d2c官网,D2C官网,潮流风尚,前沿艺术,个性设计,时装设计师平台,国际五大时装周T型台上最新的流行元素,欧洲一线设计师品牌,原创设计,设计师品牌,买手店<#else>${keywords},${keywords},D2C,d2c官网,D2C官网,潮流风尚,前沿艺术,个性设计,时装设计师平台,国际五大时装周T型台上最新的流行元素,国际新锐设计师品牌,原创设计,设计师品牌,买手店</#if>" />
<meta name="description" content="<#if description==''>D2C是一家集潮流风尚、前沿艺术、个性设计为一体的设计师集成平台。<#else>${description}</#if>" />
<meta name="viewport" content="width=device-width,height=device-height,inital-scale=1,maximum-scale=1,user-scalable=0,minimal-ui" />
<meta name="apple-mobile-web-app-capable" content="yes" />
<meta name="apple-mobile-web-app-status-bar-style" content="black" />
<meta name="format-detection" content="telephone=no" />
<meta name="wap-font-scale" content="no">
<!--<meta name="apple-itunes-app" content="app-id=980211165">-->
<meta property="data-title" content="<#if keywords==''>D2C,D2CMALL,d2c官网,D2C官网,潮流风尚,前沿艺术,个性设计,时装设计师平台,设计师品牌,国际五大时装周T型台上最新的流行元素,欧洲一线设计师品牌,原创设计,买手店<#else>${keywords},设计师品牌,${keywords},D2C,D2CMALL,潮流风尚,前沿艺术,个性设计,时装设计师平台,国际新锐设计师品牌,原创设计,买手店</#if>" />
...
<link type="text/css" href="${static_base}/nm/css/${s}.css?t=${refreshTimeStamp}" rel="stylesheet" media="screen" /> 
<#else>
...
var wx_signature='${wechat.signature}',wx_nonceStr='${wechat.nonceStr}',wx_timestamp='${wechat.timestamp}',wx_appId='${wechat.appId}';
</#if>
</script>
<#if browser=='wechat'>
...
<header>
    <div class="header fixed">
        <div class="header-back"><a href="<#if url?length gt 0>${url}<#else>javascript:history.back(1);</#if>" class="icon icon-back"></a></div>
...
<div class="icon icon-assistant" onclick="ysf.open()"></div><span>在线客服</span>
</div>
</#if>
</#if>
</#macro>
...
<div class="app-download-bar">
	<div<#if fixed?length == 0 || fixed=="true"> class="fixed"</#if>>
		...
		<div class="bar-close"><a href="javascript:$('.app-download-bar').remove()"><span class="icon icon-cross"></span></a></div>
		<div class="bar-icon"><img src="//static.d2c.cn/common/nm/img/icon_launcher.png" alt="D2C-ICON" /></div>
		<div class="bar-cont open-app">
			<div class="bar-slide">
				<div><p><strong>一站买遍@全球好设计 </strong></p><p>客服电话：4008403666（工作日9:00-24:00）</p></div>
				<div><p><strong>网罗时尚@全球好设计</strong></p><p>全球好设计，尽在D2C</p></div>
			</div>
		</div>
	</div>
</div>
