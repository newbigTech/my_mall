...
<table class="table table-grey">
    ...
    <tr class="item">
        <td><table class="no-border" width="100%">
            <tr>
                <td>退货类型：退货退款</td>
                <td>退货金额：<strong class="arial rmb">${reship.refund.totalAmount?string("currency")}</strong></td>
            ...
            <tr>
                ...
                <a href="${picture_base}${evidence}" class="img" target="_blank" style="float-left"><img src="${picture_base}${evidence}!80" width="60" alt=""></a>
                </#list>
                </td>
             </tr>
             </#if>
