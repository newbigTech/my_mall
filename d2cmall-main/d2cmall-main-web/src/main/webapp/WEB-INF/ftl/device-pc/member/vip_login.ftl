...
<div class="main-body bg-vip-login">
	<div class="main-wrap">
		...
		<form name="form-login" id="form-login" action="/member/viplogin" method="post">
			...
			<div style="padding:15px;">
				<p><input type="password" name="password" class="input" value="输入登录密码&nbsp;" default="输入登录密码&nbsp;" value="" class="input" /></p>
			</div>
			<input type="checkbox" name="auto" value="1" class="checkbox" id="auto_login" checked style="display:none;" />
			<div style="padding:15px;">
