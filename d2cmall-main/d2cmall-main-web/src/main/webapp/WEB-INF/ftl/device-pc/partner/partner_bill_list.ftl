        ...
        <table border="0" cellpadding="6" cellspacing="0" width="100%" class="table table-grey">
        	...
        	<tbody>
                ...
                <tr class="title">
                   ...
                   <td class="text-center" style="line-height:250%;">${(bill.createDate?string("yyyy/MM/dd HH:mm:ss")!)!}</td>
                   ...
                   <td class="text-center productSn" style="line-height:250%;">${(bill.productSn)!}</td>
                    ...
                    <td class="text-center" style="line-height:250%;"><#if bill.status==-1>0%<#else>${(bill.ratio)!}%</#if></td>
                    <td class="text-center" style="line-height:250%;"><#if bill.status==-1>0<#else>¥ ${(bill.rebates)!}</#if></td>
