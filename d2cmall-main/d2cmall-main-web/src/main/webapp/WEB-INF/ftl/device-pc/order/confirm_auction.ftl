...
<div class="layout layout-response layout-order">
    <form action="/auction/margin/update/${auctionMargin.id}" method="post" class="validate-form" call-back="auctionConfirm" style="padding:15px;">
        ...
        <div id="address-list" class="select-address address-list clearfix" name="address-list">
            ...
            <div class="address-item<#if address.isdefault> on</#if>" data-id="${address.id}" title="双击可以编辑地址">
                ...
                <p class="second-line">${(address.district.name)!}${address.street}&nbsp;&nbsp;<br />${address.mobile}</p>
        ...
        <table class="table table-lightgrey">
            ...
            <tbody>
                    ...
                    <td class="text-left info  border-r-none">
                        <p class="img" style="margin-top:2px;"><img src="${picture_base}/${(product.product.productImageCover)!}!80" alt="${product.title}" height="90" /></p>
                ...
                <tr class="text-right item" style="line-height:200%;background:#f8f8f8">
                    <td colspan="4" class="text-right" style="padding:10px 10px 0 10px"> 
                     <button type="submit" style="margin-top:10px" name="" id="auction-confirm" class="button button-red button-xl finalpay float-right">提交订单</button>
                   <div class="float-right" style="margin-top:10px;margin-right:10px;">
                    <p id="pay-price-wrap" class="desc" data-sn="${auctionMargin.marginSn}" style="margin:0;line-height:30px">需支付金额：&yen; <strong id="pay-price" class="important level-one">${(auctionMargin.billTotalFee)}</strong></p> 
