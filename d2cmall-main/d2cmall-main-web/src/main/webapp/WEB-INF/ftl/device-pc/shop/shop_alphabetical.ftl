...
<div class="layout layout-response layout-showroom clearfix">
	<div class="suspend-navs-showroom">
        ...
        <a class="nav-show-detail" href="javascript:;" data-url="/showroom/category/designArea" data-status="off">按分类</a>
   		<div class="suspend-navs-children">
        <div class="nav-children">	
        </div>
        </div>
    ...
    <div class="letter-top-wrap layout-response scroll-suspend" data-anchor="true"  data-scroll-holder="letter-top-holder">
    ...
    <div class="letter-wrap clearfix" id="${letter}">
        ...
        <div class="letter-right">
            ...
            <#if designer.pageGroup==letter>
                <li><a href="/showroom/designer/${designer.id}" target="_blank">${designer.name}<span class="grey">&nbsp;/&nbsp;${designer.designers}</span><#if designer.recommend==1> <i>HOT</i> </#if></a></li>
