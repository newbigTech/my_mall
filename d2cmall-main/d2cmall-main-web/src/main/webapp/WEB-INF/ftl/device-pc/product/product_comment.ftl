...
<table class="comment-item" style="word-wrap: break-word;word-break:break-all;">
	<tr>
		<td>			
			<p class="comment-content" style="font-size: 14px;"><#if comment.content?length gt 0>${comment.content}<#else>未填写评论!</#if></p>			
			...
			<div class="clearfix float-left commentimg-list">	
				...
				<div class="float-left commentimg-div">
					     <a class="hover-img" style="position:relative;" href="javascript:"><img src="${picture_base}/${path}!120" height="60" alt="" />					     										 
						 <img style="display:none;position:absolute;top:40px;" class="comment-hover-img" src="${picture_base}/${path}" height="350" alt="" />
						 </a>
				</div>
				</#list>		
			</div>
