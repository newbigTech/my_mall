<div class="account-wrap" style="margin-left:-5px;width:430px;padding:0;border:none;">
    ...
    <div class="login-type">     
		 ...
		 <form name="quicky-login" class="validate-form"  action="/member/quick/login" method="post" call-back="loginSuccessReturn" style="border:none;padding:0 16px 37px 16px;">
		 	<div class="account-input account-now">
        		...
        		<input type="text" name="loginCode" value="" class="validate-account login-l" alt="login" data-rule="mobile" disabled="disabled"  autocomplete="new-password"/>
   			 </div>
