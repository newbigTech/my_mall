     		...
     		<#list pager.list as memberInfo>
     			<tr class="title">
     				...
     				<div class="bind-headpic">
     					...
     					<#else>
     						<img src="//static.d2c.cn/common/nc/css/img/defult_headpic.jpg!/fwfh/300x300" alt=""></img>
     					</#if>
     				</div>
     				</td>
     				<td class="text-center nickname" style="line-height:250%;">${(memberInfo.displayName)!}</td>
     				<td class="text-center" style="line-height:250%;">${(memberInfo.recommendDate?string("yyyy/MM/dd HH:mm:ss")!)!}</td>
     			</tr>
     		</#list>
     		</#if>
           </tbody>
