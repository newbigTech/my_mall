...
<div style="text-align:center;padding:100px 0">
    <div style="display:inline-block;width:460px;">
        <p>请用微信扫一扫查看</p>
        <p><img id="qrcode" src="/picture/code?type=1&width=144&height=144&noLogo=true&&code=//m.d2cmall.com/flashpromotion/brand/session" width="144" alt="微信扫一扫" /><br />微信扫一扫</p>
    </div>
