					...
					<#if promotion.pcBanner>
						<div class="text-center promotion-list">
							<div class="promotion-countdown">
		              				<div class="count-down" data-startTime="${promotion.startTime?string("yyyy/MM/dd HH:mm:ss")}" data-endTime="${promotion.endTime?string("yyyy/MM/dd HH:mm:ss")}" data-serverTime="${.now?string("yyyy/MM/dd HH:mm:ss")}" ata-defined="second" data-type="split-time">
