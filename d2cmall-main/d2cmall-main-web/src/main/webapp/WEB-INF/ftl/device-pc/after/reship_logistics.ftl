...
<div class="reship step2_box" style="width:868px;height:70px;text-indent:-9999px;margin:auto;">申请退货退款</div>
    ...
    <form action="/member/reship/logistic" class="validate-form" method="post" call-back="myreship">
        ...
        <div class="form-item form-item-vertical" style="color:#FD555D;text-align:left;margin-left:18%;padding-left:10px"><i class="fa fa-info-circle"></i>该笔交易退款无法原路返回，退款需要汇到您的支付宝账户</div>
        <div class="form-item form-item-vertical" style="text-align:left;margin-left:18%">
            <label>支付宝账号</label>
            <input type="text" name="backAccountSn" id="back-account" value="${(reship.refund.backAccountSn)!}" class="input" placeholder="目前退款仅支持退到支付宝账号" style="width:35%;"/>
            <div class="tip tip-validate" data-target="back-account"></div>
        </div>
        <div class="form-item form-item-vertical" style="text-align:left;margin-left:18%">
            <label>支付宝姓名</label>
            <input type="text" name="backAccountName" value="${(reship.refund.backAccountName)!}" class="input" placeholder="财务退款时需核对该支付宝账号的姓名" style="width:35%;"/>
        </div>
        <#else>
		<div style="padding:10px;color:#FD555D"><i class="fa fa-info-circle"></i>该笔交易退款原路返回${(reship.orderPayTypeName)!}</div>
		</#if>
        <div class="form-item form-item-vertical" style="text-align:left;margin-left:18%">
            <label>物流公司</label>
        ...
        <div class="form-item form-item-vertical" style="text-align:left;margin-left:18%">
            <label>快递单号</label>
            <input type="text" class="input" size="25" name="deliverySn" id="delivery-sn" value="" style="width:35%;"/>
	...
	<div class="password-info">
    	...
    	<p style="margin-bottom:20px;">退款金额: &nbsp;&nbsp;<strong class="red">${(reship.refund.totalAmount)!}</strong></p>
    </div>
