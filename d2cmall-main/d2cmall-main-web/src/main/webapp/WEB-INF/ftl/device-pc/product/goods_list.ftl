    ...
    <div class="layout-right layout-product-right">
        ...
        <div class="list product-list clearfix">
            ...
            <div class="list-item">
                ...
                <p class="title"><#if product.topical==1><strong style="color:#FD555D">[主推]</strong></#if><a href="/product/${product.id}" target="_blank" title="${product.name}">${product.name}</a></p>
                <p class="price">
                    <span>&yen; ${(product.minPrice)!}</span>
                    <#if product.minPrice < product.originalPrice> &nbsp;<s>&yen; ${(product.originalPrice)!}</s></#if>
                </p>
            </div>
            </#list>
        </div>
