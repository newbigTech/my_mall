...
<div class="main-body">
	...
	<span class="count-down" data-function="start" data-startTime="2014/03/06 13:48:00" data-endTime="2014/03/06 14:15:00" data-serverTime="${.now?string("yyyy/MM/dd HH:mm:ss")}"></span>
	</div>
</div>
<script>
/*进入页面检测时间*/
