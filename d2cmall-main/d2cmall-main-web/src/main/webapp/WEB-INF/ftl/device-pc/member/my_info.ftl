...
<div class="layout layout-response layout-user">
    ...
    <div style="width:40px;display:table-cell;background-color:#ededed"></div><div class="layout-user-right">
        ...
        <div class="form-info n_form" style="width:100%;">
            <form name="form-info" class="validate-form" success-tip="个人信息保存成功！" action="/member/info.json" method="post">
               ...
               <div class="form-item">
                    ...
                    <#if member.memberInfo.headPic>
                    	<img src="<#if member.memberInfo.headPic?index_of('http') lt 0>//img.d2c.cn</#if>${member.memberInfo.headPic}" class="head-pic"></img>
               ...
               <div class="form-item">
                    ...
                    <div class="tip tip-validate" data-target="nickname" data-rule="nickname"  min-length="0" byte-max="30" byte-min="4" ></div>
                    
                </div>
               <div class="form-item">
                    <label><span>*</span>真实姓名</label>
                    <input type="text" name="memberDetail.name" id="name" minlength="0" maxlength="20" value="${member.memberDetail.name}" class="input"/>
                    <span class="prompts">请输入4-20位字符，可使用中文或英文</span>
                    <div class="tip tip-validate" data-target="name" data-rule="name"></div>
                </div>
               <div class="form-item checkbox">
                    <label><span>*</span>性别</label>
                    <label style="color:#ff60c9"><input type="radio" id="girl" name="sex" value="女"   style="width:2%;"<#if member.sex=='女'> checked</#if> /><label for="girl"></label> 女 </label>
                    &nbsp; &nbsp;
                    <label style="color:#598afb"><input type="radio" id="boy" name="sex" value="男"  style="width:2%;"<#if member.sex=='男'> checked</#if> /><label for="boy"></label> 男</label>
                </div>
                <!--
                <div class="form-item">
               ...
               <div class="form-item">
                	...
                	<div class="tip tip-validate" data-target="email" data-rule="email"  min-length="0" max-length="30" ></div>
                </div>
