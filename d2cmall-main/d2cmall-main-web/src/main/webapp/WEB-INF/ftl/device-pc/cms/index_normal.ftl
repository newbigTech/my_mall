...
<div class="float-search"> 
	<form name="" action="/product/list" method="get" target="_blank">
        <input type="text" name="k" id="header-keyword" class="place-holder-keyword" value="" /><button type="submit" id="float-search"><a href="javascript:" class="search-icon"><i class="fa fa-search"></i></a></button>
    </form>
</div>
    ...
    <div class="banner" id="banner-h">
        ...
        <#if homePage.blocks.block01?size gt 0>
            ...
            <li data-title="${(block.title)!}" <#if block.margin!=''> style="background:${(block.margin)!}"</#if>>
                <a href="${(block.bindUrl)!}" target="_blank"><img src="${picture_base}${(block.frontPic)!}!/strip/true" alt="${(block.title)!}"  /></a>         
            </li>
            </#list>
        </#if>
        </ul>
...
<div class="layout layout-response container lazyload">
    ...
    <#else>
       ...
       <#if block_index == 0 >
        <div class="col-5">
            <a href="${(block.bindUrl)!}" target="_blank" class="hover-img-one"><img src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.frontPic)!}" /><#if block.endPic!=null>
            <img width="${(block.width)!}" class="hover-img-two" height="${(block.height)!}" alt="${(block.title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(block.endPic)!}!/strip/true"/>
            </#if></a>
        </div>
        <#else>
    ...
    <#if pageDefine.fieldDefs.block07.status==1>
        ...
        <div class="float-with-hover col-4 fade-out <#if block_index==4 || block_index==9>hidden-two<#elseif block_index==5 || block_index==10>hidden-one</#if>">
            <a href="${(block.bindUrl)!}" target="_blank"><img alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.frontPic)!}!/strip/true" height="315" width="215"/></a>
            <#if block.endPic!=null>
            <div class="float-with-btn"><a href="${(block.bindUrl)!}" target="_blank"><img width="${(block.width)!}" height="${(block.height)!}" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.endPic)!}!/strip/true"/></a></div>
            </#if>
        </div>		
            </#list>
        </#if>
    ...
    <!--活动区-->
    <div class="title clearfix" id="navs-promotion"><img src="//static.d2c.cn/img/home/160627/images/promotion.png" border="0"/></div>
    <div class="row">
	    <#if pageDefine.fieldDefs.block10.status==1>
	        ...
	        <div class="col-activity fade-out">		   			
	            <a href="${(block.bindUrl)!}" target="_blank"><img alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.frontPic)!}!/both/765x335" height="335" width="765"/></a>
	        </div>		
	        </#list>
	        </#if>
	    </#if>
    ...
    <!--明星风范1-->
    <div class="title clearfix" id="navs-starstyle"><img src="//static.d2c.cn/img/home/160627/images/star.png" border="0"/></div>
    <div class="row">
    ...
    <#if pageDefine.fieldDefs.block15.status==1>
        ...
        <#else>		   		
        <div class="starshow">		   			
            <a href="${(homePage.blocks.block15[1].bindUrl)!}" target="_blank" class="star-hover-img"><img src="${picture_base}${(homePage.blocks.block15[1].frontPic)!}!/strip/true" alt="${(block.title)!}" class="pic-box" width="580" height="320"/></a>
            <ul>
            <#list homePage.blocks.block15 as block>
            <#if block_index lt 10>
                <li><a href="${(block.bindUrl)!}" target="_blank" data-rel="${picture_base}${(block.frontPic)!}!/strip/true"><img src="${static_base}/c/images/space.gif" data-image="${picture_base}${(block.endPic)!}!/strip/true" width="93" height="64"/></a></li>				   
            </#if>
            </#list>	
            </ul>				       				
        </div>					
        <div class="starshow">					
            <a href="${(homePage.blocks.block15[11].bindUrl)!}" target="_blank" class="star-hover-img"><img src="${picture_base}${(homePage.blocks.block15[11].frontPic)!}!/strip/true" alt="${(block.title)!}" class="pic-box" width="580" height="320"/></a>
            <ul>
            <#list homePage.blocks.block15 as block>
            <#if block_index  gt 9>
                <li><a href="${(block.bindUrl)!}" target="_blank" data-rel="${picture_base}${(block.frontPic)!}!/strip/true"><img src="${static_base}/c/images/space.gif" data-image="${picture_base}${(block.endPic)!}!/strip/true" width="93" height="64"/></a></li>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?t=1" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/women.png" border="0"/></a></div>
    <div class="row row-navs">
        ...
        <div class="float-left col-9">
            ...
            <a href="${(homePage.blocks.block19[0].bindUrl)!}" target="_blank" class="${className} hoverbg">
                <img alt="${(homePage.blocks.block19[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block19[0].frontPic)!}!/strip/true" width="490" height="322"/>
                <#if homePage.blocks.block19[0].endPic!=null>
                <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block19[0].endPic)!}!/strip/true" class="hover-img" />
                </#if> 
            </a>
        </div>
        <#if homePage.blocks.block19?size gt 0>
            <#list homePage.blocks.block19 as block>
                <#if block_index gt 0>
        			...
        			<a alt="${(block.title)!}"  class="${className} hoverbg" href="${(block.bindUrl)!}"  target="_blank">
           			 <img src="${static_base}/c/images/space.gif" data-image="${picture_base}${(block.frontPic)!}!/strip/true" alt="${(block.title)!}" width="435" height="322"/>
                    <#if block.endPic!=null>
            		<img width="435" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.endPic)!}!/strip/true" class="hover-img" />
                    </#if> 			
       				</a>
    				</div>
                    <#else>
            		...
            		<a alt="${(block.title)!}" class="${className} hoverbg" href="${(block.bindUrl)!}" target="_blank">
                	<img src="${static_base}/c/images/space.gif" data-image="${picture_base}${(block.frontPic)!}!/strip/true" alt="${(block.title)!}" width="215" height="322"/>
                    <#if block.endPic!=null>
                	<img width="315" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.endPic)!}!/strip/true" class="hover-img" />
                    </#if> 					
            		</a>
        			</div>
                    </#if>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?t=6" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/men.png" border="0"/></a></div>
    <div class="row row-navs">
        ...
        <div class="float-left col-9">
            ...
            <img alt="${(homePage.blocks.block21[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block21[0].frontPic)!}!/strip/true" width="490" height="322"/>
            <#if homePage.blocks.block21[0].endPic!=null>
            <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block21[0].endPic)!}!/strip/true" class="hover-img" />
            </#if> 
            </a>
        </div>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?t=7" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/kid.png" border="0"/></a></div>
    <div class="row row-navs">
        ...
        <div class="float-left col-9">
            ...
            <img alt="${(homePage.blocks.block27[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block27[0].frontPic)!}!/strip/true" width="490" height="322"/>
            <#if homePage.blocks.block27[0].endPic!=null>
            <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block27[0].endPic)!}!/strip/true" class="hover-img" />
            </#if> 
            </a>
        </div>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?c=1652&t=2" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/shoes.png" border="0"/></a></div>
    <div class="row row-navs">
    ...
    <#if pageDefine.fieldDefs.block23.status==1>
        <div class="float-left col-9">
            ...
            <a href="${(homePage.blocks.block23[0].bindUrl)!}" target="_blank" class="${className}">
                <img alt="${(homePage.blocks.block23[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block23[0].frontPic)!}!/strip/true" width="490" height="322"/>
                <#if homePage.blocks.block23[0].endPic!=null>
                <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block23[0].endPic)!}!/strip/true" class="hover-img" />
                </#if> 
            </a>
        </div>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?t=3" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/bg-accessories1.png" border="0"/></a></div>
    <div class="row row-navs">
        ...
        <div class="float-left col-9">
            ...
            <a href="${(homePage.blocks.block24[0].bindUrl)!}" target="_blank" class="${className}">
                <img alt="${(homePage.blocks.block24[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block24[0].frontPic)!}!/strip/true" width="490" height="322"/>
                <#if homePage.blocks.block24[0].endPic!=null>
                <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block24[0].endPic)!}!/strip/true" class="hover-img" />
                </#if> 
            </a>
        </div>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?t=2" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/bags.png" border="0"/></a></div>
    <div class="row row-navs">
      ...
      <#if pageDefine.fieldDefs.block25.status==1>
        <div class="float-left col-9">
            ...
            <a href="${(homePage.blocks.block25[0].bindUrl)!}" target="_blank" class="${className} hoverbg">
                <img alt="${(homePage.blocks.block25[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block25[0].frontPic)!}!/strip/true" width="490" height="322"/>
                <#if homePage.blocks.block25[0].endPic!=null>
                <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block25[0].endPic)!}!/strip/true" class="hover-img" />
                </#if> 
            </a>
        </div>
    ...
    <div class="clearfix title" style="margin-top:55px"><a href="//www.d2cmall.com/product/list?t=4" target="_blank"><img src="//static.d2c.cn/img/home/160627/images/house.png" border="0"/></a></div>
    <div class="row row-navs">
      ...
      <#if pageDefine.fieldDefs.block26.status==1>
        <div class="float-left col-9">
            ...
            <a href="${(homePage.blocks.block26[0].bindUrl)!}" target="_blank" class="${className} hoverbg">
                <img alt="${(homePage.blocks.block26[0].title)!}" src="${static_base}/c/images/space.gif" data-image="${picture_base}${(homePage.blocks.block26[0].frontPic)!}!/strip/true" width="490" height="322"/>
                <#if homePage.blocks.block26[0].endPic!=null>
                <img width="490" height="322" alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(homePage.blocks.block26[0].endPic)!}!/strip/true" class="hover-img" />
                </#if> 
            </a>
        </div>
    ...
    <#list homePage.blocks.block17 as block>	
        <div class="col-2 <#if block_index ==13 || block_index==27 || block_index==41 || block_index==55 || block_index==12 || block_index==26 || block_index==40 || block_index==54>hidden-one<#elseif block_index==11 || block_index==25 || block_index==39 || block_index==53 || block_index==10 || block_index==24 || block_index==38 || block_index==52>hidden-two</#if>">
            <a href="${(block.bindUrl)!}" target="_blank" class="hoverbg"><img alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.frontPic)!}!/strip/true" height="45" width="105"/>${(block.title)!}</a>
        </div>		
    </#list>
    </#if>
    </#if>
    ...
    <#list homePage.blocks.block16 as block>	
        <div class="col-2 <#if block_index ==13 || block_index==27 || block_index==41 || block_index==55 || block_index==12 || block_index==26 || block_index==40 || block_index==54>hidden-one<#elseif block_index==11 || block_index==25 || block_index==39 || block_index==53 || block_index==10 || block_index==24 || block_index==38 || block_index==52>hidden-two</#if>">
            <a href="${(block.bindUrl)!}" target="_blank"><img alt="${(block.title)!}" src="${static_base}/c/images/space.gif"  data-image="${picture_base}${(block.frontPic)!}!/strip/true" height="45" width="105"/></a>
        </div>		
    </#list>
    </#if>
    </#if>
