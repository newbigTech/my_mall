...
<div class="layout layout-response layout-user">
    ...
    <div style="width:40px;display:table-cell;background-color:#ededed"></div><div class="layout-user-right">
        ...
        <div class="form form-small" style="width:500px;">
            ...
            <form name="form-info" class="validate-form" success-tip="个人信息保存成功！" action="/partner/update.json" method="post">
                <div class="form-item">
                    <label>手机号码</label>
                    <input type="text" name="mobile" id="mobile" value="${(partner.mobile)!}" class="input" maxlength="11"/>
                ...
                <div class="form-item">
                    <label>真实姓名</label>
                    <input type="text" name="name" id="name" minlength="2" maxlength="20" value="${(partner.name)!}" class="input" />
                    <div class="tip tip-validate" data-target="name"></div>
                </div>
                <div class="form-item">
                    <label>性别</label>
                    <label><input type="radio" id="girl" name="sex" value="女" class="checkbox"<#if partner.sex=='女'> checked</#if> /> 女 </label>
                    &nbsp; &nbsp;
                    <label><input type="radio" id="boy" name="sex" value="男" class="checkbox"<#if partner.sex=='男'> checked</#if> /> 男</label>
                </div>
                <div class="form-item">
                    <label>腾讯QQ</label>
  ...
  <p><strong>一、D2C“全球好设计”</strong>是中国大陆一家的全球好设计（以下称本平台），为全球时尚人士提供原创、新颖、独特、品质、高性价比的设计师产品和品牌。该平台属于杭州迪尔西时尚科技有限公司所有，参加活动用户使用本平台推广、批发、零售本平台服饰的，则默认为同意本协议，并同意成为本平台的分销商(此处的分销是指，同意本平台的协议及所有政策，享受本平台供货，并在本平台货品基础上发展下级经销商或进行直接销售的行为)。</p>
...
<p>2、分销用户在下单后，联系本平台售后人员获取单号，并关注该单号，如遇问题件，请积极主动联系快递公司和本平台工作人员进行解决。由于快递原因造成的延误，本平台不承担责任。本平台会尽量与快递公司协商帮助处理问题。</p>
...
<p><strong>五、杭州迪尔西时尚科技有限公司拥有本协议最终解释权，并有权根据需要修改本协议的任何条款。一旦修改了本协议的任何条款，将会在网站上提供最新版本（包括其生效日期）。杭州迪尔西时尚科技有限公司鼓励用户定期浏览本协议。</strong></p>
       </p>
       <p style="text-indent:0;font-size:13px;letter-spacing:0;">
       	 <input type="checkbox" id="apply-check" style="vertical-align:middle; margin-top:-2px; margin-bottom:1px;"/>我同意该分销商协议
       </p> 
       <br />
    	  <button type="button" id="add-new-address" disabled="disabled" class="button button-red apply" style="margin-left:250px;">申请成为分销商</button>
