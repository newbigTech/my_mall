			...
			<li>
				<div class="promotionshow">
					<p class="img hover-fade">
						...
						<#if hover==1>
							<img class="hover-img" src="//static.d2c.cn/img/topic/product/${product.id}.png" alt="" />
						</#if>
						</a>
					</p>
		            ...
		            <p class="price">
		                ...
		                <#if (product.currentPrice?exists && product.currentPrice lt product.originalPrice)> &nbsp;<s>&yen; ${(product.originalPrice?string("currency")?substring(1))!}</s></#if>
		            </p>
