	            ...
	            <div class="login-type">     
					 ...
					 <input type="hidden" name="auto"  value="0" />
					 	<div class="account-input account-now">
			        		...
			        		<input type="text" name="loginCode" value="" class="validate-account login-l" alt="login"  data-rule="mobile" disabled="disabled"  style="padding-left:5px;" autocomplete="new-password" />
		       			 </div>
			        	<div class="account-input" style="width:65%">
			                <span class="input-tip">输入短信验证码</span>
			                <input type="text" name="code" value=""/>
			                <button type="button" data-source="" data-type="MEMBERMOBILE"  data-register="true" class="button button-grey validate-send pn">获取验证码</button>
	          		  	</div>
	          		 </form>
				    </div>
			    </div>
