...
<html xmlns="//www.w3.org/1999/xhtml" xmlns:wb="//open.weibo.com/wb">
<head>
...
<meta name="description" content="D2C是一家集潮流风尚、个性设计为一体的设计师集成平台，致力于为消费者推荐全球优秀的设计师品牌，除设计师品牌限量销售外，更有私人定制服务，同时在中国各大城市开设实体店。" />
...
<link rel="apple-touch-startup-image" media="screen and (orientation: portrait)" href="//static.d2c.cn/ipad/img/system/start_up_p.png">
<link rel="apple-touch-startup-image" media="screen and (orientation: landscape)" href="//static.d2c.cn/ipad/img/system/start_up_l.png">
<!--[if lt IE 9]>
...
<#else>
<link type="text/css" href="${static_base}/nc/css/common.css?t=${refreshTimeStamp}" rel="stylesheet" media="screen" />
</#if>
<!--[if lt IE 9]>
...
<script type="text/javascript" src="${static_base}/nc/js/utils/jquery.autocomplete.js?t=${refreshTimeStamp}"></script>
...
var online= [];
var _hmt = _hmt || [];
var _py = _py || [];_py.push(['a', '9U..Cvv8h4lbWIcOzq05FVADpP']);_py.push(['domain','stats.ipinyou.com']);_py.push(['e','']);
	...
	<div class="header-user clearfix">
		<ul>
			<li> 
				...
				<#if LOGINMEMBER.nickname><a href="/member/info">${LOGINMEMBER.nickname}</a><#else><a href="javascript:;">亲爱的用户</a></#if><i>｜</i>
					 <#if !LOGINMEMBER.d2c>
			...
			<li class="relative user-collect"><a href="javascript:;"><span class="collection-down">我的收藏</span></a><i>｜</i>
			...
			<li class="relative cart" <#if !LOGINMEMBER.d2c>data-type="login"</#if>><a href="/cart/list" target="_blank" class="parent"><div class="template-m display-none"><div class="text-center loading"><h3 class="loading-text">购物车中还没有商品，赶紧选购吧!</h3><img class="loading-img" src="//static.d2c.cn/img/home/150727/loading.gif"></div><div class="template-list"></div></div>购物车<span id="cart-nums-id">0</span></a><#if LOGINMEMBER.id!=null><i>｜</i></#if></li>
			 <#if LOGINMEMBER.id!=null><li><a href="/member/logout">退出</a></li></#if>
		</ul>
	</div>
...
<div class="layout layout-response layout-order">
    <form action="/order/create" method="post" id="order-form" class="validate-form" target="_self" style="padding:15px;">
        ...
        <h2 class="order-title" style="margin-bottom:20px"><a href="/address/list" target="_blank" class="float-right blue">管理地址</a>收货地址</h2>
        ...
        <div id="address-list" class="select-address address-list clearfix" name="address-list">
            ...
            <div class="address-item<#if address.isdefault> on</#if>" data-id="${address.id}" title="双击可以编辑地址">
                <p class="first-line"><span class="first-f"><strong>${(address.name)!}</strong>&nbsp;&nbsp;&nbsp;${(address.province.name)?default("")}${(address.city.name)?default("")}</span><#if address.isdefault><span class="red is-default" rel="${address.id}">【默认】</span><#else><span class="set-default"><a href="javascript:" rel="${address.id}" id="tip${address.id}" class="grey">【设为默认】</a></span></#if></p>
                <p class="second-line"><span class="address-value">${(address.district.name)!}${address.street}</span>&nbsp;&nbsp;<br />${address.mobile}</p>
                <input type="radio" name="addressId" value="${address.id}"<#if address.isdefault> checked</#if> class="display-none" />
                <i class="fa check"></i>
            </div>
            </#list>
        ...
        <h2 class="order-title" style="margin-bottom:20px"><a href="/cart/list" class="blue float-right">修改购物车</a>购买清单</h2>
            ...
            <#if orderItem?exists && orderItem.productSku.status gt 0 && orderItem.productSku.availableStore gt 0>
                <tr class="item">
                    <td class="text-left info  border-r-none">
                        ...
                        <p class="img" style="margin-top:2px;"><img src="${picture_base}/${(orderItem.sp1?eval.img)!}!80" alt="${orderItem.productName}" height="90" /></p>
                      	<p style="color:red;"><#if orderItem.after==0><span class="red">【该商品不支持七天无理由退换货】</span></#if><#if orderItem.cod==0><span>【该商品不支持货到付款】</span></#if><#if orderItem.promotionName gt 0><span>【${(orderItem.promotionName)!}】</span></#if><#if orderItem.orderPromotionName gt 0><span>【${(orderItem.orderPromotionName)!}】</span></#if></p>
                        <p><a href="/product/${orderItem.productId}" target="_blank">${orderItem.productName}</a>
                        <p class="grey">${orderItem.sp1?eval.name}：${orderItem.sp1?eval.value}&nbsp;&nbsp;&nbsp;<#if orderItem.sp2 && (orderItem.sp2?eval)?size gt 0 >${orderItem.sp2?eval.name}：${orderItem.sp2?eval.value}</#if>&nbsp;&nbsp;&nbsp; 设计师：${orderItem.designerName}</p>
                        <p class="green"></p>
                    </td>
                    <td class="text-center border-l-none border-r-none"> 
                    <#if orderItem.promotionPrice gt 0>
                    	<p><strong class="unit price">${(orderItem.productPrice-orderItem.promotionPrice)?string("currency")?substring(1)}</strong></p>
                    	 <p class="grey" style="font-size:12px;text-decoration:line-through;">&yen;${orderItem.productPrice?string("currency")?substring(1)}</p>
                    <#else>
                    	<p><strong class="unit price">${orderItem.productPrice?string("currency")?substring(1)}</strong></p>
                    	<#if orderItem.productPrice!=orderItem.originalPrice><p style="text-decoration:line-through;">&yen;${orderItem.originalPrice}</p></#if>
                    </#if>
                    </td>
                    <td class="text-center border-l-none border-r-none">
                        ...
                        <input type="hidden" name="quantity" value="${orderItem.productSku.availableStore}" size="2" class="input text-center noime" />
                        <div class="tip">目前库存只剩${orderItem.productSku.availableStore}件 </div>
                        <#else>
                        <#assign quantity = orderItem.quantity />
                        ${orderItem.quantity}
                        <input type="hidden" name="quantity" value="${orderItem.quantity}" size="2" class="input text-center noime" />
                        </#if>
                    </td>
                    <td class="text-center border-l-none ">
                        <p class="red">&yen;<strong class="subtotal" style="font-size:15px;"> ${(orderItem.totalPrice-orderItem.promotionAmount)?string("currency")?substring(1)}</strong></p>
              ...
              <#if exceptions gt 0>
                 <tr class="space item">
                  ...
                  <#list orderItems?if_exists as orderItem>
                        ...
                        <#if !orderItem.productSku?exists || orderItem.productSku.status lte 0>
                                	<img src="//static.d2c.cn/img/home/160627/images/order-down.png" border="0" style="display:block;position:absolute;top:0;left:0;">
                        <#elseif (orderItem.productSku.availableStore lte 0 && orderItem.productSku.freezeStore gt 0)>
                                 	<img src="//static.d2c.cn/img/home/160627/images/order_change.png" border="0" style="display:block;position:absolute;top:0;left:0;">
                        <#elseif (orderItem.productSku.availableStore lte 0)>
                                	<img src="//static.d2c.cn/img/home/160627/images/order-soldout.png" border="0" style="display:block;position:absolute;top:0;left:0;">
                        </#if>
                        <img src="${picture_base}/${(orderItem.sp1?eval.img)!}!80" alt="${orderItem.productName}" height="90" />
                        </p>
                        <p class="grey">${orderItem.productSn}</p>
                        <p><a href="/product/${orderItem.productId}" target="_blank"  class="grey">${orderItem.productName}</a></p>
                        <span class="display-block grey arial" style="margin-top:3px;">${orderItem.sp1?eval.name}：${orderItem.sp1?eval.value}&nbsp;&nbsp;&nbsp;<#if orderItem.sp2 && (orderItem.sp2?eval)?size gt 0 >${orderItem.sp2?eval.value}：${orderItem.sp2?eval.name}</#if>&nbsp;&nbsp;&nbsp;设计师：${orderItem.designerName}</span>
                        </div>
                        </td>
                        <td class="border-r-none border-l-none text-center">
                        <#if orderItem.promotionPrice gt 0>
                    	<p class="grey">&yen;<strong class="unit price ">${(orderItem.productPrice-orderItem.promotionPrice)?string("currency")?substring(1)}</strong></p>
                    	 <p class="grey" style="font-size:12px;text-decoration:line-through;">&yen;${orderItem.originalPrice?string("currency")?substring(1)}</p>
                   		 <#else>
                ...
                <tr class="no-border">
                    <td colspan="4" rowspan="1" class="no-padding" style="vertical-align:top">
                        ...
                        <textarea name="memo" style="width:100%" rows="1" class="class="input" onKeyDown="checkLength()" onKeyUp="checkLength()" onPaste="checkLength()"></textarea>
                    </td>
                 </tr>
                  <tr class="space">
                    <td colspan="4"></td>
                ...
                <tr class="no-border">
                    <td colspan="4" style="padding:0;">
                        <div class="order-toggle-item" <#if ableCoupons?size gt 0 || disableCoupons?size gt 0>style="border-bottom:1px solid #DEDEDE"</#if>><p class="order-coupon"><strong>优惠券使用<#if ableCoupons?size gt 0><b></b></#if><i class="coupon-down"></i></strong></p></div>
                        ...
                        <div class="display-none" style="margin-top:20px;">
                            <div class="tab-small" id="change-tab">
                                <a href="javascript:" class="selected" data-type="enable">可用优惠券(${ableCoupons?size})</a>
                                <a href="javascript:" data-type="disable">不可用优惠券(${disableCoupons?size})</a>
                            </div>
                            <div>
                            <div id="coupons-enable" style="overflow:hidden;border:1px solid #ededed;border-top:none;">
                            <#if ableCoupons>
                            ...
                            <div class="order-coupon-item text-center" data-type="enable">
                            	...
                            	<input type="checkbox" name="coupons" value="${coupon.code}" data-type="DISCOUNT" rel="${coupon.amount/100}" class="coupon-checkbox display-none" />
                            </div>
                            ...
                            <div class="order-coupon-item text-center" data-type="enable">
                           		 <i></i>
                            	<div class="coupon-expiredate">
                            		<p><strong><span style="font-size:22px;padding-right:3px;">&yen;</span>${coupon.amount}</strong></p>
                            		<p style="margin-top:12px;">有效期至</p>
                            		<p>${coupon.expireDate?string("yyyy年MM月dd日")}</p>
                            	</div>
                            	<div class="coupon-show enable">
                            	...
                            	<input type="checkbox" name="coupons" value="${coupon.code}" rel="${coupon.amount}" class="coupon-checkbox display-none" />
                            </div>
                            </#if>
                            </#list>
                            <#else>
                            ...
                            <#if coupon.type=="DISCOUNT">
                             <div class="order-coupon-item disable text-center">
                            	...
                            	<div class="direction-info">
                            	 ...
                            	 <input type="checkbox" disabled name="coupons" value="${coupon.code}" data-type="DISCOUNT" rel="${coupon.amount/100}" class="coupon-checkbox display-none" />
                            </div>
                            ...
                            <#else>
                             <div class="order-coupon-item disable text-center">
                            	...
                            	<div class="direction-info">
                            	 ...
                            	 <input type="checkbox" disabled name="coupons" value="${coupon.code}" rel="${coupon.amount}" class="coupon-checkbox display-none" />
                            </div>
                            </#if>
                            </#list>
                            </#if>
                ...
                <tr class="no-border item">
                    <td colspan="4" style="padding-top:60px;padding-left:0">
                       ...
                       <div class="nocoupon"><span class="invoice-content">暂不需要</span><a href="javascript:;" class="invoice" style="padding-left:20px;font-size:16px;color:#5591D0">修改</a></div>
                ...
                <tr class="item">
                    ...
                    <td class="text-right" style="line-height:200%;border:none;">
                        <p>&yen; <strong id="total-amount" rel="${order.totalAmount+order.promotionAmount}">${(order.totalAmount+order.promotionAmount)?string("currency")?substring(1)}</strong></p>
                        <p class="grey"><#if order.promotionAmount gt 0>－</#if>&yen; <strong id="promotion-amount" rel="${order.promotionAmount}">${(order.promotionAmount)?string("currency")?substring(1)}</strong></p>
                        <p class="punctuation grey">&yen; <strong id="coupon-amount" rel="">0</strong></p>
                        <p class="grey"><#if order.promotionAmount gt 0>＋</#if>&yen; <strong id="ship-fee" rel="${order.shippingRates}">${order.shippingRates?string("currency")?substring(1)}</strong></p>
                        <p>&yen; <strong id="total-price" rel="${order.totalAmount+order.shippingRates}">${(order.totalAmount+order.shippingRates)?string("currency")?substring(1)}</strong></p>
                    </td>
                </tr>
            </tbody>
            <tfoot>
                <tr class="text-right item" style="line-height:200%;background:#f8f8f8">
                    <td colspan="4" class="text-right order-tip" style="padding:10px 10px 0 10px"  <#if cod==0>data-cod="false"</#if> > 
                     <#if cod==0><p style="color:red;clear:both;margin-top:10px" id="order-tips">本订单为定制商品或特殊商品,或收货地址为非中国大陆地区,故不支持货到付款方式</p></#if>   
                     <input type="hidden" name="cod" value="${cod}" />
                     <input type="hidden" name="longitude" value="" />
            		 <input type="hidden" name="latitude" value="" />
                     <button type="button" style="margin-top:10px" name="" id="order-confirm" class="button button-red button-xl finalpay float-right">提交订单</button>
                   <div class="float-right" style="margin-top:10px;margin-right:10px;">
                    <p id="pay-price-wrap" style="margin:0;line-height:30px">需支付金额：&yen; <strong id="pay-price" class="important level-one"><#if order.totalAmount+order.shippingRates lte 0>0<#else>${(order.totalAmount+order.shippingRates)?string("currency")?substring(1)}</#if></strong></p> 
                    <p style="margin:0;line-height:20px;color:#999;"><span>收货信息：</span><span class="order-address"></span></p> &nbsp; &nbsp;
                   </div> 
    ...
    <div class="form">
        ...
        <form name="address-form" class="validate-form form-cinfo" call-back="{{func}}" action="{{url}}" method="post">
            ...
            <div class="form-item">
                ...
                <select name="regionPrefix" id="province" rel="{{regionPrefix}}" class="input province" style="width:130px;"> 
                    <option value="">选择省份</option> 
                    </select> 
                    <select name="regionMiddle" id="city" rel="{{regionMiddle}}" style="width:100px;" class="input city"> 
                    <option value="">选择城市</option> 
                    </select> 
                    <select name="regionSuffix" id="district" rel="{{regionSuffix}}" style="width:100px;" class="input district"> 
            ...
            <div class="form-item">
                ...
                <input type="text" name="mobile" id="mobile" maxlength="20" value="{{mobile}}" class="input"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                <div class="tip tip-validate" data-target="mobile" data-rule="mobile"></div>
            </div>
            <div class="form-item">
                <label>电话号码</label>
                <input type="text" name="phonePrefix" id="phonePrefix" maxlength="4" value="{{phonePrefix}}" style="width:10%;" class="input utilSetNumber" placeholder="区号" /> - <input type="text" name="phoneMiddle" id="phoneMiddle" maxlength="8" value="{{phoneMiddle}}"  style="width:20%;" class="input utilSetNumber" placeholder="电话号码" /> - <input type="text" maxlength="5" name="phoneSuffix" value="{{phoneSuffix}}"  style="width:15%;" class="input" placeholder="分机" />
            </div>
...
<script id="address-item-template" type="text/html">
    <div class="address-item{{if isdefault}} on{{/if}}" data-id="{{id}}">
        <p class="first-first"><span class="first-f"><strong>{{name}}</strong>&nbsp;&nbsp;&nbsp;&nbsp;{{province.name}}{{city.name}}</span>{{if isdefault}}<span class="is-default red" rel="{{id}}">【默认】</span>{{else}}<span class="set-default"><a href="javascript:" rel="{{id}}" id="tip{{id}}" class="grey">【设为默认】</a></span>{{/if}}</p>
...
<script id="invoice-template" type="text/html">
  <div class="form">
  		<style>
			...
			.input:focus,.new-input:active {border:1px solid #FD555D}
    	</style>
  	<div class="form-info" style="font-size:14px;">
  		<div class="form-item" style="padding:5px 0 5px 0">
  			<label>开具发票</label> <span class="checkbox"><input type="checkbox" name="checkall" checked class="checkbox" id="checkbox" /><label for="checkbox" style="background:url(//static.d2c.cn/common/nc/css/img/blue_checked.png) top left no-repeat;width:16px;height:16px;background-size:cover;border:none;margin-top:1px;"> </label></span>
  		</div>
  		<div class="form-item" style="padding:5px 0 5px 0">
  			<label>发票类型</label><span>普通发票</span>
  		</div>
  		<div class="form-item" style="padding:5px 0 5px 0">
  			<label>发票抬头</label> <input type="text" name="mydrawee"  value="{{data}}" class="input"  placeholder="请输入个人 / 公司抬头" />
  		</div>
  	...
  	<div style="margin:10px 0  50px 0"><button class="button button-red button-s" style="margin-right:20px;" id="invoice-sure">保存</button><button class="button button-s button-grey" class="invoice-cancel" onclick="$('.modal-remove').trigger('click');">取消</button></div>
  </div>
</script> 
    ...
    <div class="footer-menu">
        ...
        <div class="clearfix">
            ...
            <dl>
                ...
                <dd class="first-line"> <a href="${base}/page/faq_shipping" target="_blank" rel="nofollow">购物流程</a></dd>
            ...
            <dl>
                ...
                <dd class="first-line"><a href="${base}/page/about" target="_blank" rel="nofollow">D2C介绍</a></dd>
                <dd><a href="${base}/page/job" target="_blank" rel="nofollow" style="color:#FD555D">招贤纳士</a></dd>
            ...
            <dl class="d2c-email">
                <dt style="margin-left:35px;"><img src="${static_base}/c/images/space.gif" data-image="//static.d2c.cn/other/qrode/img/d2c_email.png" width="254" height="52" alt="订阅电子报" /></dt>
                <dd class="none subscribe-email">
                    <form name="subscribe-email" class="validate-form" success-tip="恭喜，您成功订阅了我们的邮件！" call-back="false" action="/subscribe/email" method="post">
                        <input type="text" name="email" id="subscribe-email" value="" placeholder="请输入邮箱" /><button type="submit">订阅</button>
                        <div class="tip tip-validate" data-target="subscribe-email"></div>
                    </form>           
                </dd>                               
                <dd class="none service">
                <img src="${static_base}/c/images/space.gif" data-image="//static.d2c.cn/other/qrode/img/wechat_service.jpg" alt="微信服务号:d2cmall" width="150" height="150"  />
                <p>服务号：d2cmall</p>
                </dd>
                <dd class="none service-detail">
                	<p><strong>设计师品牌入驻及艺人造型剧组合作</strong></p>
                	<p>Email：media@d2cmall.com</p>
                	<p>在线申请(online application)：<a href="/brandapply" target="_blank" style="color:#fc668f;" rel="nofollow">立即申请</a></p>
                	<p style="margin-top:18px;"><strong>投诉与建议(Feedback)</strong><p>
                	<p>CEO Email：ceo@d2cmall.com<p>
                </dd>
                <dd class="none clearfix share-weibo">
              	  <a href="//weibo.com/myd2c" target="_blank"><span></span><p>关注D2C官方微博</p></a>
           		 </dd>
            </dl>
           </div>
            <div class="footer-copyright">
            	<div class="copyright-info">
            	<p style="margin-right:75px;text-align:right;">Powered byD2C-Copyright © 2015 D2CMALL.COM - All Rights Reserved.</p>
            	...
            	<p style="text-align:right;"><a target="_blank" href="//www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010602004682" style="display:inline-block;text-decoration:none;padding-left:5px;color:#666;"><img src="//static.d2c.cn/img/home/160627/images/police.png" style="float:left;"/>浙公网安备 33010602004682号</a></p>
            	</div>
            </div>
        </div>
    </div>
...
<script src="https://qiyukf.com/script/cdf7ede373825ab5af9d955d1fb3556c.js?uid=<#if LOGINMEMBER.id!=null>${LOGINMEMBER.id}</#if>&name=<#if LOGINMEMBER.id!=null>${LOGINMEMBER.displayName}</#if>" defer async></script>
...
(function() {
    ...
    /*jingzan*/
    (function(param){var c = {query:[], args:param||{}};c.query.push(["_setAccount","636"]);(window.__zpSMConfig = window.__zpSMConfig||[]).push(c);var zp = document.createElement("script"); zp.type = "text/javascript"; zp.async = true;zp.src = ("https:" == document.location.protocol ? "https:" : "http:") + "//cdn.zampda.net/s.js";var s = document.getElementsByTagName("script")[0]; s.parentNode.insertBefore(zp, s);})(window.__zp_tag_params);
	/*
	boya
	*/
