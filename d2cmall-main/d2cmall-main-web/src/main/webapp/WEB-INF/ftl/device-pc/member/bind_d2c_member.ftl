...
<div class="account-body">
	...
	<div class="account-count">
	    ...
	    <div class="account-wrap">
	        <form name="bind" id="form-bind" action="/member/bind" method="post">
	            ...
	            <div class="account-bar text-right"><a href="javascript:;" style="color:#FD555D">使用第三方帐号登录请绑定手机号</a></div>
	            ...
	            <div style="width:430px;height:150px;background:url(//static.d2c.cn/img/home/160627/images/bind_bg.png) no-repeat;" class="second-hide">
	...
	<div class="copyright clearfix">
            	<div class="copyright-info">
			        ...
			        <p style="text-align:right;"><a target="_blank" href="//www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010602004682" style="display:inline-block;text-decoration:none;padding-left:5px;color:#999;"><img src="//static.d2c.cn/img/home/160627/images/police.png" style="float:left;"/>浙公网安备 33010602004682号</a></p>
            	</div>
        </div>
</div>
<#if nofloat?length == 0>
