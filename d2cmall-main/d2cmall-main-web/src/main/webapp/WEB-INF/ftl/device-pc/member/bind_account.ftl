...
<div class="main-body bg-user-center">
    <div class="main-wrap text-center" style="padding-top:100px;height:400px;line-height:35px;">
		<form name="bind" id="bind-form" action="/callback/bindMember" method="post">
			...
			<div>
				<p>请输入邮箱或手机号</p>
				<p><input type="text" name="loginCode" style="font-size:18px;" class="input-l text-center" value="" /></p>
			</div>
			<div id="have-account" class="display-none">
				<p>这个账号已经注册过了哦，请输入密码继续</p>
				<p><input type="password" name="password" style="font-size:18px;" class="input-l text-center" value="" /></p>
			</div>
			<div id="no-account" class="display-none">
				...
				<p><input type="password" name="password" style="font-size:18px;" class="input-l text-center" value="" /></p>
				<p>确认一次输入的密码</p>
				<p><input type="password" name="repassword" style="font-size:18px;" class="input-l text-center" value="" /></p>
			</div>
			<div id="submit-button" class="display-none" style="padding-top:15px;">
				<p><button type="submit" name="" class="b-b button-l">确定</button></p>
			</div>
		</form>	
	</div>
</div>
