        ...
        <div class="form form-small">
            ...
            <form method="post" confirm="确定要充值吗?请务必保证金额正确！" class="validate-form" action="/o2opay/recharge">
                <div class="form-item form-item-vertical">
                    <label>充值时间</label>
                    <input type="text" name="payDate" id="pay-date" value="${(.now?string("yyyy-MM-dd"))!}" class="input input-l" >
                    <div class="tip tip-validate" data-target="pay-date"></div>
                </div>
                <div class="form-item form-item-vertical">
                    <label>会员账号</label>
                    <input type="text" name="accountSn" id="account-sn" value="" placeholder="请输入会员的登录账号" class="input input-l" >
                ...
                <div class="form-item form-item-vertical">
                    ...
                    <select id="pay-channel" name="payChannel" class="input input-l" style="width:100%">
                        ...
                        <option value="UNIONPAY"<#if RequestParameters.paymentType=='UNIONPAY'> selected</#if>>银联支付</option>
                    </select>
                    <div class="tip tip-validate" data-target="pay-channel"></div>
                </div>
                <div class="form-item form-item-vertical online-pay display-none">
                    <label>支付账号</label>
                    <input type="text" id="pay-account" name="payAccount" value="" placeholder="充值时使用的支付宝账号或银行卡号等" class="input input-l" >
                </div>
                <div class="form-item form-item-vertical online-pay display-none">
                    <label>支付流水号</label>
                    <input type="text" id="pay-sn" name="paySn" value="" placeholder="通过支付宝或银行支付时的流水单号" class="input input-l" >
                </div>
                <div class="form-item form-item-vertical">
                    <label>充值金额</label>
                    <input type="text" id="recharge-amount" name="rechargeAmount" maxlength="6" value="" placeholder="输入正整数" class="input input-l" >
                ...
                <div class="form-item form-item-vertical">
                    <label>备注说明</label>
                    <textarea id="memo" name="memo" value="" class="input input-l" style="width:100%;height:60px;"></textarea>
                </div>
