    ...
    <form method="post" class="validate-form" action="/comment/o2o/insert.json">
        ...
        <div class="form-item">
         ...
         <div class="form-item form-item-vertical">
            <label>评价与反馈:</label>
            <textarea style="height: 100px;" name="content" id="content" onKeyDown="checkLength()" onKeyUp="checkLength()" onPaste="checkLength()" class="input" >${(comment.content)!}</textarea>
