	...
	<@m.page_menu menu_item="wishItem"/>
		...
		<#if pager.list?exists >
			<#list pager.list as list>
				...
				<td>
					<#if list.crowdItem?exists><a href='/crowds/product/${list.crowdItem.id}' target='_blank'>${list.productName}</a>
			...
			<#else>
				<tr><td colspan="8" style="line-height:150px;text-align:center;">暂时无记录</td></tr>
			</#if>
			</table>
