<#import "templates/public_pc.ftl" as m>
    ...
    <div class="lazyload">
        <div class="layout-response list clearfix" style="width:1125px;margin-top:30px;font-size:14px;font-family:'Microsoft Yahei'">
			  	...
			  	<#if pager.list?exists && pager.list?size gt 0>
					<#list pager.list as list>
						<tr class="line-item" style="border-left:none;border-right:none">	
							...
							<td class="border-l-none border-r-none"><strong>&yen;${list.offer?string("currency")?substring(1)}</strong></td>
