<div class="account-wrap" style="margin-left:-5px;width:430px;padding:0;border:none;">
    ...
    <div class="login-type">     
		 ...
		 <form name="quicky-login" class="validate-form"  action="/member/bind" method="post" call-back="bindSuccessReturn" style="border:none;padding:0 16px 37px 16px;">
		 	<div class="account-input account-now">
        		<input type="hidden" name="nationCode" disabled="disabled" value="86" class="mobile-code" />
        		 <span class="choose-country" id="choose-country" style="position:absolute;line-height:36px;top:10px;"><strong id="mobile-code">+86</strong><em class="fa fa-caret-down" style="top:11px;"></em></span>
        		<span class="input-tip" style="left:80px">请输入手机号</span>
        		<input type="text" name="loginCode" value="" class="validate-account login-l" alt="login" data-rule="mobile"   autocomplete="new-password"  style="padding-left:80px;"/>
   			 </div>
