...
<div class="layout layout-response layout-user">
    ...
    <div style="width:40px;display:table-cell;background-color:#ededed"></div><div class="layout-user-right">
        ...
        <div class="form form-small">
            ...
            <form method="post" success-tip="收款成功！请转入“收款管理”中再次确认。" confirm="确定要收取该客户款项吗?请务必保证金额和单号正确！" redirect-url="/o2opay/bill" class="validate-form" action="/o2opay/receive">
                ...
                <div class="form-item form-item-vertical">
                    <label>收款金额</label>
                    <input type="text" id="receive-amount" name="receiveAmount" maxlength="6" value="" placeholder="输入正整数" class="input input-l" >
                ...
                <div class="form-item form-item-vertical">
                    <label>零售单号</label>
                    <input type="text" id="retail-sn" name="retailSn" value="" placeholder="零售单号请务必填写正确" class="input input-l" >
