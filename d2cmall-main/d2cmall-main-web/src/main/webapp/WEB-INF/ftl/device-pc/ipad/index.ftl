...
<meta name="keywords" content="预售,设计师品牌,全球好设计,SHOWROOM D2C,Designer To Customer,原创设计,个性,原创设计概念店,设计师品牌集成店,国际新锐设计师品牌,原创设计" />
...
<link rel="apple-touch-startup-image" href="${static_base}/t/img/start_up_l.png" media="screen and (orientation:landscape)" />
<link rel="apple-touch-startup-image" href="${static_base}/t/img/start_up_p.png" media="screen and (orientation:portrait)" />
...
<div class="swiper-container">
	<div class="swiper-wrapper">
		...
		<div class="swiper-slide"><img src="${static_base}/c/images/space.gif" data-src="${picture_base}${designer.path}" alt="${designer.name}" data-id="${designer.id}" data-name="${designer.name}" /></a></div>
		</#if>
		</#list>
	</div>
</div>
...
<div class="clone">
	<#list list as designer>
	<#if designer_index lte 60>
	<img data-id="${designer.id}" data-name="${designer.name}" data-group="${designer.pageGroup}" data-area="${designer.designArea}" data-src="${picture_base}${designer.path}" />
	</#if>
	</#list>
</div>
<script>
