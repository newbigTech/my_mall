	...
	<div class="designer-bar">
		...
		<div class="designer-swiper swiper-container">
			<div class="swiper-wrapper">
		    	...
		    	<#if designer.headPic?exists><div class="swiper-slide" data-id="${designer.id}" data-name="${designer.name}"<#if designer_index==0> data-status="current"</#if>><a href="?designerId=${designer.id}"><img src="${picture_base}${designer.headPic}!120" alt=""></a></div></#if>
		    	</#list>    	
		    </div>
		</div>
	</div>
