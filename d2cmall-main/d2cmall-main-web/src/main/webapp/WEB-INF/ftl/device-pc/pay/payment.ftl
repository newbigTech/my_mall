...
<div class="layout layout-response layout-order">
    <form name="pay-form" id="pay-form" action="/payment" method="post" style="padding:15px;">
        ...
        <div class="pay-order-detail clearfix" style="text-align:center">
        	...
        	<p>请尽快支付，否则订单会被取消哦！</p>
        	<p class="grey" style="margin-top:8px;">应付金额：<span class="display-none" id="total-price">${(order.totalPay)}</span><span class="red" style="font-size:24px;font-weight:bold;" id="pay-price">${(order.totalPay)?string("currency")?substring(1)}</span></p>
           	<p class="grey">（商品金额：&yen;<span class="small">
           	${order.totalAmount?string("currency")?substring(1)}</span>&nbsp;&nbsp;运费：<span class="small">&yen; ${order.shippingRates?string("currency")?substring(1)}</span>&nbsp;&nbsp;优惠金额：<span class="small" id="coupon-price">&yen;
            ...
            <div class="pay-user-info clearfix">
            	<p class="float-left">收货信息：<span class="small">${order.reciver}</span>&nbsp;&nbsp;&nbsp;&nbsp;${order.contact}&nbsp;&nbsp;&nbsp;&nbsp;地址：${order.province}${order.city}${order.address}</p>
            ...
            <ul>
                <li class="payment-li on">
                    ...
                    <ul class="alipay clearfix">
                        <input type="radio" id="ONLINE" name="type" value="ONLINE"  checked="checked" class="online-pay"/>
                        <li class="pay-li" id="defult"><input type="radio" id="ALIPAY" data-type="ALIPAY" name="payment" method="creditPay" value="ALIPAY" /><label  class="ALIPAY">支付宝<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" id="WXSCANPAY" data-type="WX_SCANPAY" name="payment" method="creditPay" value="WX_SCANPAY" /><label  class="WXSCANPAY">微信扫码支付<i class="select"></i></label></li>
                    </ul>
                    <p class="bank-pay">其他支付方式<i></i></p>
                    <ul class="bank clearfix" style="padding-bottom:25px;display:none;">
                        
                        <li class="pay-li"><input type="radio" class="COMM" data-type="ALIPAY" name="payment" method="bankPay" value="COMM" /><label class="COMM">交通银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="ICBC" data-type="ALIPAY" name="payment" method="bankPay" value="ICBC" /><label class="ICBC">中国工商银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="CMB" data-type="ALIPAY" name="payment" method="bankPay" value="CMB" /><label class="CMB">招商银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="CCB" data-type="ALIPAY" name="payment" method="bankPay" value="CCB" /><label class="CCB">中国建设银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="BOC" data-type="ALIPAY" name="payment" method="bankPay" value="BOC" /><label class="BOC">中国银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="ABC" data-type="ALIPAY" name="payment" method="bankPay" value="ABC" /><label class="ABC">中国农业银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="SPABANK" data-type="ALIPAY" name="payment" method="bankPay" value="SPABANK" /><label class="SPABANK">平安银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="CEB" data-type="ALIPAY" name="payment" method="bankPay" value="CEB" /><label class="CEB">中国光大银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="CMBC" data-type="ALIPAY" name="payment" method="bankPay" value="CMBC" /><label class="CMBC">民生银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="GDB" data-type="ALIPAY" name="payment" method="bankPay" value="GDB" /><label class="GDB">广发银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="CITIC" data-type="ALIPAY" name="payment" method="bankPay" value="CITIC" /><label class="CITIC">中信银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="HZCB" data-type="ALIPAY" name="payment" method="bankPay" value="HZCB" /><label class="HZCB">杭州银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="NBBANK" data-type="ALIPAY" name="payment" method="bankPay" value="NBBANK" /><label class="NBBANK">宁波银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="SDB" data-type="ALIPAY" name="payment" method="bankPay" value="SDB" /><label class="SDB">深发展<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="SHBANK" data-type="ALIPAY" name="payment" method="bankPay" value="SHBANK" /><label class="SHBANK">上海银行<i class="select"></i></label></li>
                        <li class="pay-li"><input type="radio" class="SPDB" data-type="ALIPAY" name="payment" method="bankPay" value="SPDB" /><label class="SPDB">浦发银行<i class="select"></i></label></li>
                    </ul>
                </li>
        ...
        <div class="text-center" style="margin-top:20px;">
            <button type="button" name="order-pay" id="order-pay" class="button button-red button-xl finalpay" style="padding:0 40px"> 去付款 </button>
        </div>  
    </form>
</div>
...
var pubsage_sign="";var pubsage_url="";var url=window.location.href;var domain=document.domain;var mat=url.match(/adtiid=([^&#]*)/);var iid=mat?mat[1]:"";if(iid==""||typeof(iid)=="undefined"){var uid=function(cookiekey){var strCookie=document.cookie;var arrCookie=strCookie.split(";");var value="";for(var i=0;i<arrCookie.length;i++){var arr=arrCookie[i].split("=");if(cookiekey==arr[0].replace(/(^\s*)|(\s*$)/g,"")){value=arr[1];break}}return value}("_ws_uid");if(uid==""||typeof(uid)=="undefined"){pubsage_url="tca.sagetrc.com"}else{var strAry=domain.split(".");var host=strAry[strAry.length-2]+"."+strAry[strAry.length-1];var pf=uid.split(".");if(pf[0]=="tqh"){pubsage_url="tqh_"+pubsage_sign+"."+host}if(pf[0]=="tgg"){pubsage_url="tgg_"+pubsage_sign+"."+host}if(pf[0]=="tsg"){pubsage_url="tsg_"+pubsage_sign+"."+host}if(pf[0]=="tdsp"){pubsage_url="tdsp_"+pubsage_sign+"."+host}if(pf[0]!="tsg"&&pf[0]!="tgg"&&pf[0]!="tqh"&&pf[0]!="tdsp"){pubsage_url="trc_"+pubsage_sign+"."+host}}}else{if(iid.match("^g")!=null){pubsage_url="tgg.sagetrc.com"}if(iid.match("^q")!=null){pubsage_url="tqh.sagetrc.com"}if(iid.match("^s")!=null){pubsage_url="tsg.sagetrc.com"}if(iid.match("^d")!=null){pubsage_url="tdsp.sagetrc.com"}if(iid.match("^g|^q|^s|^d")==null){pubsage_url="t1.sagetrc.com"}}var pubsage_conv_id=27449;var pubsage_conv=pubsage_conv||[];(function(){try{var d=document;var at=d.createElement("script");at.type="text/javascript";at.async=true;at.src=("https:"==document.location.protocol?"https:":"http:")+"//"+pubsage_url+"/trc/atac/conv_x.js?id="+pubsage_conv_id;var s=d.getElementsByTagName("script")[0];s.parentNode.insertBefore(at,s)}catch(e){}})();
...
!function(w,d,e){
	...
	var b=location.href,c=d.referrer,f,s,g=d.cookie,h=g.match(/(^|;)\s*ipycookie=([^;]*)/),i=g.match(/(^|;)\s*ipysession=([^;]*)/);if (w.parent!=w){f=b;b=c;c=f;};u='//stats.ipinyou.com/cvt?a='+e('9U.lB.y5Dp8LMFfq9ozBEYROcJP0')+'&c='+e(h?h[2]:'')+'&s='+e(i?i[2].match(/jump\%3D(\d+)/)[1]:'')+'&u='+e(b)+'&r='+e(c)+'&rd='+(new Date()).getTime()+'&OrderNo='+e(_orderno)+'&Money='+e(_money)+'&ProductList='+e(_productList)+'&e=';
	function _(){
		if(!d.body){setTimeout(_(),100);}else{s= d.createElement('script');s.src = u;d.body.insertBefore(s,d.body.firstChild);}
	}_();
...
<div class="service-suspend">
	...
	<div class="service-content text-info customer"  onclick="NTKF.im_openInPageChat();"><a href="javascript:;">客服</a></div>
