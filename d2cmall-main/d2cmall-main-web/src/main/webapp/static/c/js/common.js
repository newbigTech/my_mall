...
$(function(){
	...
	*/
	...
	if ($(window).width() < 1870){
		...
		if (is_read_tip!=1) {$('.service-suspend .suspend-tip').show();}
		/*
		$('.service-suspend .suspend-side').hover(function(){
			...
			if (data.loggedIn==false){
				...
				$.post(url+'?'+new Date().getTime(),function(data){
					if (data.status!=0)	{
						...
						$('#'+plus).animate({fontSize:'0px',top:obj.offset().top+5,left:(obj.offset().left+obj.outerWidth()/2),opacity:0},'2500',function(){
							$(this).remove();
						});
					}else{
						if ($('#h-'+plus).size()==0){
	...
	$('button[name=alert_mobile]').click(function(){
		...
		if (!re_email.test(code.val())&&!re_mobile.test(code.val())){
			...
			$.post('/remind',{productId:pid.val(),remindType:type,mobilemail:code.val(),name:name},function(data){
	...
	if ($('#store-list').size()>0){
		var store_list=[
			{'city':'北京','name':'来福士','address':'北京市东城区东直门南大街1号来福士购物中心2层09铺','tel':'010-84098064','img':'http://static.d2c.cn/img/home/150420/store/01.jpg','href':'/store/code/5'},
			{'city':'重庆','name':'万象城	','address':'重庆市九龙坡区重庆华润中心万象城第 LG层LG193号商铺','tel':'023-68419856','img':'http://static.d2c.cn/img/home/150420/store/02.jpg','href':'/store/code/17'},
			{'city':'北京','name':'国贸','address':'北京市朝阳区建国门外大街1号国贸商城三期负一楼3B 109 110商铺','tel':'010-85351656','img':'http://static.d2c.cn/img/home/150420/store/03.jpg','href':'/store/code/22'},
			{'city':'重庆','name':'盈嘉中心','address':'重庆市江北观音桥步行街2号融恒时代广场盈嘉中心L3-13号','tel':'023-67694975','img':'http://static.d2c.cn/img/home/150420/store/04.jpg','href':'/store/code/18'},
			{'city':'北京','name':'蓝色港湾','address':'北京市朝阳区朝阳公园路6号院2号楼','tel':'010-59056133','img':'http://static.d2c.cn/img/home/150420/store/05.jpg','href':'/store/code/9'},
			{'city':'南京','name':'德基','address':'南京市中山路18号德基广场二期F415号商铺','tel':'025-86777422','img':'http://static.d2c.cn/img/home/150420/store/06.jpg','href':'/store/code/19'},
			{'city':'北京','name':'朝北大悦城','address':'北京市朝阳区朝阳北路101号朝阳大悦城2F-06号','tel':'010-85519493','img':'http://static.d2c.cn/img/home/150420/store/07.jpg','href':'/store/code/24'},
			{'city':'北京','name':'新光天地','address':'北京市朝阳区建国路87号华贸商城（新光天地）B1082  D2C专柜','tel':'010-57381342','img':'http://static.d2c.cn/img/home/150420/store/09.jpg','href':'/store/code/24'},
			{'city':'南通','name':'八佰伴','address':'南通市人民中路45号八佰伴1楼','tel':'0513-89093776','img':'http://static.d2c.cn/img/home/150420/store/10.jpg?0.1','href':'/store/code/16'},
			{'city':'杭州','name':'湖滨银泰','address':'浙江省杭州市上城区延安路245号湖滨银泰四期B1-122','tel':'0571-89779375','img':'http://static.d2c.cn/img/home/150420/store/11.jpg','href':'/store/code/10'},
			{'city':'昆明','name':'顺城','address':'昆明市崇仁街9号顺城购物中心E2-08A','tel':'0871-63637720','img':'http://static.d2c.cn/img/home/150420/store/12.jpg','href':'/store/code/8'},
			{'city':'杭州','name':'万象城','address':'浙江省杭州市江干区富春路万象城购物中心4楼487号商铺','tel':'0571-81186238','img':'http://static.d2c.cn/img/home/150420/store/13.jpg','href':'/store/code/4'},
			{'city':'深圳','name':'海岸城','address':'深圳市南山区文心五路33号海岸城购物中心二层203-205号铺','tel':'0755-86359420','img':'http://static.d2c.cn/img/home/150420/store/14.jpg','href':'/store/code/20'},
			{'city':'合肥','name':'银泰','address':'安徽省合肥市庐阳区 长江中路98号','tel':'0551-65852159','img':'http://static.d2c.cn/img/home/150420/store/15.jpg','href':'/store/code/13'},
			{'city':'大庆','name':'松雷','address':'大庆市让胡路区中原路3号 大庆松雷购物休闲广场','tel':'0459-5926950','img':'http://static.d2c.cn/img/home/150420/store/17.jpg','href':'/store/code/6'},
			{'city':'长春','name':'卓展','address':'吉林省长春市重庆路1255号卓展购物中心4楼','tel':'0431-88483292','img':'http://static.d2c.cn/img/home/150420/store/18.jpg','href':'/store/code/23'},
			{'city':'常州','name':'吾悦广场','address':'江苏省常州市武进区武宜北路19号武进吾悦广场1F-110','tel':'0519-85523990','img':'http://static.d2c.cn/img/home/150420/store/19.jpg','href':'/store/code/24'},
			{'city':'石家庄','name':'北国商城','address':'石家庄中山东路188号北国商城三楼C区D2C','tel':'0311-89669373','img':'http://static.d2c.cn/img/home/150420/store/20.jpg','href':'/store/code/24'},
			{'city':'温州','name':'银泰','address':'温州市解放南路9号温州世贸中心银泰2楼D2C','tel':'0577-88008509','img':'http://static.d2c.cn/img/home/150420/store/21.jpg','href':'/store/code/24'}		
		];			
