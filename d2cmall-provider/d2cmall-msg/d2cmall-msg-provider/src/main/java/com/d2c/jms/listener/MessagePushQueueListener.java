...
import com.d2c.msg.model.MessageDef.MessageChannel;
import com.d2c.msg.service.MessageDefService;
import com.d2c.msg.service.MessageService;
import com.d2c.msg.service.MsgPushService;
import com.d2c.msg.service.WeixinPushService;
import com.d2c.msg.support.MsgResource;
...
public class MessagePushQueueListener extends AbsMqListener {
	...
	private void pushMessage(String idStr, Long defId, String creator, Long timestamp, String[] openIds) {
		...
		if (!MessageChannel.WEIXINTOPARTNER.name().equals(messageDef.getChannel())) {
			...
			com.d2c.msg.model.Message message = new com.d2c.msg.model.Message();
