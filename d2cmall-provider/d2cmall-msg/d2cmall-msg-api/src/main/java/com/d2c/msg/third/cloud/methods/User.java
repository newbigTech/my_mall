package com.d2c.msg.third.cloud.methods;

import java.net.HttpURLConnection;
import java.net.URLEncoder;

import com.alibaba.fastjson.JSONObject;
import com.d2c.msg.third.cloud.core.Sign;
import com.d2c.msg.third.cloud.models.CheckOnlineReslut;
import com.d2c.msg.third.cloud.models.CodeSuccessReslut;
import com.d2c.msg.third.cloud.models.QueryBlacklistUserReslut;
import com.d2c.msg.third.cloud.models.QueryBlockUserReslut;
import com.d2c.msg.third.cloud.models.TokenReslut;
import com.d2c.msg.third.cloud.util.HostType;
import com.d2c.msg.third.cloud.util.HttpUtil;
...
public class User {
	 ...
	 * 
	 * @param userId:用户
	 *            Id，最大长度 64 字节.是用户在 App 中的唯一标识码，必须保证在同一个 App 内不重复，重复的用户 Id
	 *            将被当作是同一用户。（必传）
	 * @param name:用户名称，最大长度
	 *            128 字节.用来在 Push 推送时显示用户的名称.用户名称，最大长度 128 字节.用来在 Push
	 *            推送时显示用户的名称。（必传）
	 * @param portraitUri:用户头像
	 *            URI，最大长度 1024 字节.用来在 Push 推送时显示用户的头像。（必传）
	 *
	 * @return TokenReslut
	 **/
	 ...
	 *            将被当作是同一用户。（必传）
	 * @param name:用户名称，最大长度
	 *            128 字节。用来在 Push 推送时，显示用户的名称，刷新用户名称后 5 分钟内生效。（可选，提供即刷新，不提供忽略）
	 * @param portraitUri:用户头像
	 *            URI，最大长度 1024 字节。用来在 Push 推送时显示。（可选，提供即刷新，不提供忽略）
	 *
