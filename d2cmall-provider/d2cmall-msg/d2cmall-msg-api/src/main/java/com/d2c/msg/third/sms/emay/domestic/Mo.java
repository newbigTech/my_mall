...
package com.d2c.msg.third.sms.emay.domestic;

public class Mo implements java.io.Serializable {
	private static final long serialVersionUID = -3544020610802455425L;
	...
	public Mo(java.lang.String addSerial, java.lang.String addSerialRev, java.lang.String channelnumber,
			java.lang.String mobileNumber, java.lang.String sentTime, java.lang.String smsContent) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				&& ((this.addSerial == null && other.getAddSerial() == null)
						|| (this.addSerial != null && this.addSerial.equals(other.getAddSerial())))
				&& ((this.addSerialRev == null && other.getAddSerialRev() == null)
						|| (this.addSerialRev != null && this.addSerialRev.equals(other.getAddSerialRev())))
				&& ((this.channelnumber == null && other.getChannelnumber() == null)
						|| (this.channelnumber != null && this.channelnumber.equals(other.getChannelnumber())))
				&& ((this.mobileNumber == null && other.getMobileNumber() == null)
						|| (this.mobileNumber != null && this.mobileNumber.equals(other.getMobileNumber())))
				&& ((this.sentTime == null && other.getSentTime() == null)
						|| (this.sentTime != null && this.sentTime.equals(other.getSentTime())))
				&& ((this.smsContent == null && other.getSmsContent() == null)
						|| (this.smsContent != null && this.smsContent.equals(other.getSmsContent())));
		__equalsCalc = null;
		return _equals;
	}
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(Mo.class,
			true);
