...
public interface AccountService {
	 ...
	 * @return
	 */
	int doUpdateAmount(Long accountId, BigDecimal cashAmount, BigDecimal giftAmount);
	 ...
	 * @return
	 */
	int doUpateLimitAmount(Long accountId, BigDecimal limitGiftAmount, Date limitDate);
