...
import com.d2c.order.handle.ApriceMethod;
import com.d2c.order.handle.DiscountMethod;
import com.d2c.order.handle.ProcessPriceBehavior;
import com.d2c.order.handle.PromotionCalculateItem;
import com.d2c.order.handle.PromotionCalculateResult;
import com.d2c.order.handle.ReducePriceMethod;
import com.d2c.order.handle.XoffYFullPscMethod;
import com.d2c.order.handle.XoffYFullStepMethod;
import com.d2c.order.handle.XoffYPayMethod;
import com.d2c.order.handle.XoffYProcessPriceBehavior;
import com.d2c.order.handle.XoffYStepMethod;
import com.d2c.order.handle.XoffYUnlimitedMethod;
...
public class PromotionRunServiceImpl implements PromotionRunService {
	...
	private PromotionCalculateItem calculateDiscountSetting(DiscountSetting discountSetting,
		...
		item.setPromotionPrice(promotionPrice.setScale(0, BigDecimal.ROUND_HALF_UP));
	...
	public PromotionCalculateResult getProductCombPromotion(List<IPromotionInterface> promotionConditions) {
		...
		for (PromotionCalculateItem item : list) {
			...
			BigDecimal promotionAmount = currenPromotion.multiply(ratePromotion).setScale(0, BigDecimal.ROUND_HALF_UP);
