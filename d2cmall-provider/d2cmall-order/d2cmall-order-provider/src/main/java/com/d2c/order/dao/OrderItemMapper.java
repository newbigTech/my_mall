...
public interface OrderItemMapper extends SuperMapper<OrderItem> {
	...
	int doChangePartner(@Param("itemId") Long itemId, @Param("partnerId") Long partnerId,
			@Param("parentId") Long parentId, @Param("partnerRatio") BigDecimal partnerRatio,
			@Param("parentRatio") BigDecimal parentRatio);
