...
public interface RequisitionItemService {
	 ...
	 * @return
	 */
	RequisitionItem doPurchaseInsert(RequisitionItem requisitionItem, String operator);
	 ...
	 * @return
	 */
	RequisitionItem doReshipInsert(RequisitionItem requisitionItem, String operator, String deliveryCorp,
	 ...
	 * @return
	 */
	RequisitionItem doDeportAllInsert(RequisitionItem requisitionItem, String operator);
