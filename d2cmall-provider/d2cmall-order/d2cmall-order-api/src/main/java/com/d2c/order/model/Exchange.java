...
public class Exchange extends PreUserDO {
	...
	public String getDeliveryCorpCode() {
		return LogisticsResource.convertName(deliveryCorp);
	}
	...
	public String getExchangeDeliveryCorpCode() {
		return LogisticsResource.convertName(exchangeDeliveryCorp);
	}
	...
	public JSONObject toJson() {
		...
		obj.put("deliveryCorpCode", this.getDeliveryCorpCode());
		...
		obj.put("exchangeDeliveryCode", this.getExchangeDeliveryCorpCode());
