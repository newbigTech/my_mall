...
public class AlipaySubmit {
	...
	private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
		// 除去数组中的空值和签名参数
		Map<String, String> sPara = AlipayCore.parasFilter(sParaTemp);
		// 生成签名结果
		String mysign = AlipayBase.BuildMysign(sPara);
		// 签名结果与签名方式加入请求提交参数组中
	...
	public static String query_timestamp() throws MalformedURLException, DocumentException, IOException {
		...
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.partnerId
