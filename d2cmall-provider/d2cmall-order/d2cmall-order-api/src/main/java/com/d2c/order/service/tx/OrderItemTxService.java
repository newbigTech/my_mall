...
public interface OrderItemTxService {
	 ...
	 * @return
	 */
	int doSysSuccess(Long orderItemId, String operator, Integer off, BigDecimal diffAmount);
	 ...
	 * @return
	 */
	int doAutoSuccess(Long itemId, String operator, Integer rebate, BigDecimal diffAmount);
