...
public interface OrderQueryService {
	 ...
	 * @return
	 */
	PageResult<Long> findExpireOrder(int closeTime, Order.OrderType[] type, PageModel page);
	 ...
	 * @return
	 */
	int countExpireOrder(int closeTime, Order.OrderType[] type);
	 ...
	 * @return
	 */
	List<Order> findByTop1000(Date startDate, Date endDate, BigDecimal amount);
