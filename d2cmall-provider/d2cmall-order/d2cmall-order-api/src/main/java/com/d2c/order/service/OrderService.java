...
public interface OrderService {
	 ...
	 * @return
	 */
	int updateOrderShippingAddress(Long id, String contact, String province, String city, String address,
	 ...
	 * @return
	 */
	int updateOrderStatusByDeliverySn(String deliverySn, OrderStatus success);
	 ...
	 * @param collageOrder
	 */
	void doSimulateOrder(CollageOrder collageOrder);
