...
public interface StoreService {
	 ...
	 * @return
	 */
	PageResult<Store> findBySearch(StoreSearcher storeSearcher, PageModel pageStore);
	 ...
	 * @return
	 */
	PageResult<HelpDTO> findBySearchForHelp(StoreSearcher storeSearcher, PageModel pageStore);
