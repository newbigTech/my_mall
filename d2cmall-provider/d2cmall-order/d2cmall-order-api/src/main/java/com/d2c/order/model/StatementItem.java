...
public class StatementItem extends PreUserDO {
	...
	public String getOrderTypeName() {
		if (StringUtil.isNotBlank(this.getOrderType()) && OrderType.distribution.name().equals(this.getOrderType())) {
			return "经销";
		}
		return "普通";
	}
	...
	public StatementItem(Reship reship, ProductSku sku, OrderItem orderItem, Integer status) {
		...
		// 比例,按实发数/下单数 TODO 实付金额是否也要，待问产品
