...
public interface StatementService {
	 ...
	 * @return
	 */
	List<Statement> findByDesigner(int settleYear, int settleMonth, Long designerId);
	 ...
	 * @return
	 */
	List<Map<String, Object>> countByDesigner(int settleYear, int settleMonth, Long designerId);
