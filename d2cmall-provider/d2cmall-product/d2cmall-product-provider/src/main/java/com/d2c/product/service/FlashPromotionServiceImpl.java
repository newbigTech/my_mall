...
public class FlashPromotionServiceImpl extends ListServiceImpl<FlashPromotion> implements FlashPromotionService {
	...
	@Override
	public FlashPromotion findByStartDateAndScope(Date startDate, Integer promotionScope) {
		return flashPromotionMapper.findByStartDateAndScope(startDate, promotionScope);
	}

	@Override
	public List<FlashPromotion> findNoEndOrderByScore() {
		return flashPromotionMapper.findNoEndOrderByScore();
	}
}
