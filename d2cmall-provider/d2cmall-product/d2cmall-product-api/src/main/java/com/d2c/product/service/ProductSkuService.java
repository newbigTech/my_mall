...
public interface ProductSkuService {
	 ...
	 * @return
	 */
	int doCancelFreezeAndDeduceStock(Long productId, Long productSkuId, int quantity);
	 ...
	 * @return
	 */
	int doCancelFreezeAndDeduceFlashStock(Long productId, Long productSkuId, int quantity);
