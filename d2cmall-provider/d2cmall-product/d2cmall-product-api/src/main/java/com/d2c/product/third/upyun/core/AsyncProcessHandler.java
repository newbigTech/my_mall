...
public class AsyncProcessHandler {
	...
	protected Result process(Map<String, Object> params) throws IOException, UpException {
		...
		params.put(CompressHandler.Params.TASKS, URLEncoder
				.encode(Base64Coder.encodeString(params.get(CompressHandler.Params.TASKS).toString()), "UTF-8"));
		...
		// 设置签名
		conn.setRequestProperty(AUTHORIZATION, sign("POST", "/pretreatment/", date, params));
	...
	public AsyncProcessHandler(String bucketName, String userName, String password) {
		...
		this.password = MD5Util.encodeMD5Hex(password);
	}
	...
	protected String sign(String method, String URI, String date, Map<String, Object> params) throws UpException {
		...
		// List<Map.Entry<String, Object>> list = new
		// ArrayList<Map.Entry<String, Object>>(params.entrySet());
		// Collections.sort(list, new Comparator<Map.Entry<String, Object>>() {
		// public int compare(Map.Entry<String, Object> o1, Map.Entry<String,
		// Object> o2) {
