...
import com.d2c.cms.dao.SubModuleMapper;
import com.d2c.cms.dto.SectionValueDto;
import com.d2c.cms.model.Section;
import com.d2c.cms.model.SectionValue.RelationType;
	...
	private String processValuesByType(SectionValueDto dto) {
		...
		if (dto.getType() == 12) {
			if (RelationType.BRAND.name().equals(dto.getRelationType())) {
				...
				products = productSearcherQueryService.findSaleProductByPromotion(dto.getRelationId(), 0,
						new PageModel(1, 8));
			}
		}
