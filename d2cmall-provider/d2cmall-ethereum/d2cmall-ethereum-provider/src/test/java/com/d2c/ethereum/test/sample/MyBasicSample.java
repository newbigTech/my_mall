package com.d2c.ethereum.test.sample;
...
public class MyBasicSample implements Runnable {
    ...
    private static class Config {
        @Bean
        public MyBasicSample myBasicSample() {
            return new MyBasicSample();
        }
    }
     ...
     */
    public MyBasicSample(String loggerName) {
