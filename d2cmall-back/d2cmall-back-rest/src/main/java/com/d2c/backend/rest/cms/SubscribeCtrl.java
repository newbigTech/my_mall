...
import com.d2c.cms.service.SubscribeService;
import com.d2c.common.api.page.PageModel;
import com.d2c.common.api.page.PageResult;
import com.d2c.common.api.response.Response;
import com.d2c.common.api.response.SuccessResponse;
import com.d2c.common.base.utils.BeanUt;
import com.d2c.msg.service.EmailService;
...
public class SubscribeCtrl extends BaseCtrl<SubscribeSearcher> {
	...
	public Response sendMail(String idStr, String content) {
		SuccessResponse result = new SuccessResponse();
		result.setStatus(-1);
		if (StringUtils.isBlank(content)) {
			result.setMessage("发送内容不能为空");
		...
		for (Long id : ids) {
			subscribe = subscribeService.findById(id);
			if (subscribe != null && LoginUtil.checkEmail(subscribe.getSubscribe())) {
				emailService.send(subscribe.getSubscribe(), "D2C全球好设计", content);
			}
		}
		result.setStatus(1);
		result.setMessage("发送成功！");
