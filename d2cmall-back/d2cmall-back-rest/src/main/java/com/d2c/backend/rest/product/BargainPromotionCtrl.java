...
public class BargainPromotionCtrl extends BaseCtrl<BargainPromotionSearcher> {
	...
	public Response doHelp(String unionId, String bargainId) throws NotLoginException, BusinessException {
		Admin admin = this.getLoginedAdmin();
		bargainPriceService.addBargainHelp(unionId, bargainId, admin.getUsername(), "", admin.getId());
		return new SuccessResponse();
	}
