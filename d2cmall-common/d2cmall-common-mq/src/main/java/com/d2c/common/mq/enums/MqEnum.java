...
public enum MqEnum {
	...
	FLUSH_CACHE(MqTypeEnum.TOPIC, "清除缓存"),

	TIMING_PRODUCT("商品定时"), TIMING_PROMOTION("活动定时"),

	TIMING_SCREEN("闪屏定时"), TIMING_PUSH("推送定时"), TIMING_RULE("规则定时"),

	PRODUCT_SUMMARY("商品统计"), BRAND_SUMMARY("品牌统计"), REFRESH_MEMBER("刷新会员"),

	UNLOCK_ACCOUNT("解锁钱包"), BREACH_AUCTION("拍卖违约"), AWARD_QUALIFIED("抽奖资格"),
