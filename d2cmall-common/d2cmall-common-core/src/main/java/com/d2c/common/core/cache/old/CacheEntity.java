...
public class CacheEntity<T> implements Serializable {
	...
	public CacheEntity(String cacheKey, T cacheContext) {
		this();
		this.cacheKey = cacheKey;
		this.cacheContext = cacheContext;
	}

	public CacheEntity(String cacheKey, T cacheContext, long timeoutStamp) {
		this(cacheKey, cacheContext);
		this.timeoutStamp = timeoutStamp;
	}

	public CacheEntity(String cacheKey, T cacheContext, int validityTime) {
		this(cacheKey, cacheContext);
	...
	public T getCacheContext() {
		return cacheContext;
	}

	public void setCacheContext(T cacheContext) {
		this.cacheContext = cacheContext;
	}
